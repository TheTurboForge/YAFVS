...
use super::direct_api::{OPERATOR_UUID_ENV, validate_operator_uuid};
...
pub fn command_native_scan_new_system(
    ...
    command_scan(
        ...
        &GuardedApi,
        &operation_key(),
        &std::env::var(OPERATOR_UUID_ENV).unwrap_or_default(),
    )
}
...
fn command_scan(
    ...
    let operator_uuid = validate_operator_uuid(operator_uuid.trim(), OPERATOR_UUID_ENV)
