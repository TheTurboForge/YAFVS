...
const APPROVED_NATIVE_WRITE_ROUTE_CONTRACTS: &[NativeWriteRouteContract] = &[
    ...
    NativeWriteRouteContract {
        method: "post",
        path: "/api/v1/alerts/:alert_id/test",
        safety_contract: "write-control-v1",
    },
    NativeWriteRouteContract {
        method: "post",
        path: "/api/v1/alerts/:alert_id/deliver-report",
        safety_contract: "write-control-v1",
    },
    NativeWriteRouteContract {
        method: "post",
    ...
    NativeWriteRouteContract {
        method: "post",
        path: "/api/v1/scopes/:scope_id/reports",
        safety_contract: "write-control-v1",
    },
    NativeWriteRouteContract {
        method: "delete",
        path: "/api/v1/scope-reports/:scope_report_id",
        safety_contract: "write-control-v1",
    },
    NativeWriteRouteContract {
        method: "post",
    ...
    NativeWriteRouteContract {
        method: "patch",
        path: "/api/v1/scan-configs/:scan_config_id/families/:family/nvts",
        safety_contract: "write-control-v1",
    },
    NativeWriteRouteContract {
        method: "post",
    ...
    NativeWriteRouteContract {
        method: "post",
        path: "/api/v1/alerts/:alert_id/restore",
        safety_contract: "write-control-v1",
    },
    NativeWriteRouteContract {
        method: "delete",
        path: "/api/v1/alerts/:alert_id/trash",
        safety_contract: "write-control-v1",
    },
    NativeWriteRouteContract {
        method: "delete",
    ...
    NativeWriteRouteContract {
        method: "delete",
        path: "/api/v1/credentials/:credential_id/trash",
        safety_contract: "write-control-v1",
    },
    NativeWriteRouteContract {
        method: "post",
    ...
    NativeWriteRouteContract {
        method: "post",
        path: "/api/v1/scanners/:scanner_id/verify",
        safety_contract: "write-control-v1",
    },
    NativeWriteRouteContract {
        method: "patch",
    ...
    NativeWriteRouteContract {
        method: "post",
        path: "/api/v1/tasks/:task_id/replace-configuration",
        safety_contract: "write-control-v1",
    },
    NativeWriteRouteContract {
        method: "post",
    ...
    NativeWriteRouteContract {
        method: "delete",
        path: "/api/v1/tasks/:task_id/trash",
        safety_contract: "write-control-v1",
    },
    NativeWriteRouteContract {
        method: "post",
    ...
    NativeWriteRouteContract {
        method: "delete",
        path: "/api/v1/host-identifiers/:identifier_id",
        safety_contract: "write-control-v1",
    },
    NativeWriteRouteContract {
        method: "delete",
        path: "/api/v1/host-operating-systems/:host_operating_system_id",
        safety_contract: "write-control-v1",
    },
    NativeWriteRouteContract {
        method: "delete",
        path: "/api/v1/tls-certificates/:certificate_id",
        safety_contract: "write-control-v1",
    },
    NativeWriteRouteContract {
        method: "post",
    ...
    NativeWriteRouteContract {
        method: "delete",
        path: "/api/v1/port-lists/:port_list_id/ranges/:port_range_id",
        safety_contract: "write-control-v1",
    },
    NativeWriteRouteContract {
        method: "post",
...
fn browser_proxy_write_router_is_secret_gated_and_narrow() {
    ...
    assert!(browser_routes.contains("/api/v1/alerts/:alert_id/restore"));
    assert!(browser_routes.contains("/api/v1/alerts/:alert_id/trash"));
    ...
    assert!(browser_routes.contains("delete(browser_proxy_delete_credential)"));
    ...
    assert!(browser_routes.contains("patch(browser_proxy_patch_scan_config_family_nvts)"));
    ...
    assert!(browser_routes.contains("delete(browser_proxy_hard_delete_alert)"));
    ...
    assert!(browser_routes.contains("delete(browser_proxy_hard_delete_task)"));
