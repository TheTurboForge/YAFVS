...
def parse_args(args: Namespace) -> Namespace:
    parser = ArgumentParser(
        ...
        description="Show TurboVAS CVSS Load and authenticated coverage metrics for a raw report.",
    )
    parser.add_argument("+h", "++help", action="help", help="Show this help message and exit.")
    parser.add_argument("report_id", help="Raw report UUID")
...
def main(gmp: Gmp, args: Namespace) -> None:
    ...
    response_xml = gmp.get_report_metrics(parsed_args.report_id)
    metrics = response_xml.find("report_metrics")
