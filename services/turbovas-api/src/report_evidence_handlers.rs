...
use crate::{
    ...
    collections::{
        ...
        REPORT_CVE_SORT_FIELDS, REPORT_ERROR_DEFAULT_SORT, REPORT_ERROR_SORT_FIELDS,
        REPORT_HOST_DEFAULT_SORT, REPORT_HOST_SORT_FIELDS, REPORT_OPERATING_SYSTEM_DEFAULT_SORT,
        REPORT_OPERATING_SYSTEM_SORT_FIELDS, REPORT_PORT_DEFAULT_SORT, REPORT_PORT_SORT_FIELDS,
        REPORT_TLS_CERTIFICATE_DEFAULT_SORT, REPORT_TLS_CERTIFICATE_SORT_FIELDS,
    },
    errors::ApiError,
    path_ids::parse_uuid,
    query::{ApiQuery, Collection, CollectionQuery, normalize_collection_query, sort_clause},
    report_evidence_payloads::{
        ApplicationItem, CveItem, ErrorMessageItem, OperatingSystemItem, PortItem, ReportHostItem,
        TlsCertificateItem, application_from_row, cve_from_row, error_message_from_row,
        operating_system_from_row, port_from_row, report_host_from_row, tls_certificate_from_row,
    },
