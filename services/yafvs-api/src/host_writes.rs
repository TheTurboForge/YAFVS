...
pub(crate) async fn patch_host(
    ...
    resolve_host_write_operator_owner(&tx, &operator).await?;
    ...
    ensure_host_is_human_owned(host_state.owner_id)?;
...
pub(crate) async fn delete_host_identifier(
    ...
    ensure_host_is_human_owned(identifier_state.owner_id)?;
...
pub(crate) async fn delete_host_operating_system(
    ...
    ensure_host_is_human_owned(host_operating_system_state.owner_id)?;
