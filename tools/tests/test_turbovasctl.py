...
class TurboVASCtlTests(unittest.TestCase):
    ...
    def test_user_management_native_contracts_cover_reads_writes_and_proxy_allowlists(self):
        ...
        for key, replaces in expected_operations.items():
            ...
            values = operation["x_turbovas_values"]
            method, _path = key
            expected_exposure = (
                "direct-read"
                if method == "get"
        ...
        direct_reads = set(turbovasctl.DIRECT_API_SCRIPTABLE_ENDPOINTS)
        self.assertIn("/api/v1/user-management/users", direct_reads)
        self.assertIn("/api/v1/user-management/users/{}", direct_reads)
        self.assertNotIn("/api/v1/auth/settings", direct_reads)

        proxy_templates, proxy_errors = turbovasctl.native_api_gsad_proxy_allowlist_templates(root)
        write_operations, write_errors = turbovasctl.native_api_gsad_proxy_write_allowlist_operations(root)
        ...
        rows = {
            ...
            for row in turbovasctl.native_api_migration_matrix_rows(root)
        ...
        self.assertEqual(
            turbovasctl.native_api_migration_matrix_contract_summary(list(rows.values())),
    ...
    def test_native_tooling_state_status_only_is_chat_safe(self):
        ...
        self.assertEqual(status_only["details"]["direct_api_contract"]["openapi_marked_direct_operation_count"], 200)
        self.assertEqual(status_only["details"]["direct_api_contract"]["openapi_marked_direct_read_operation_count"], 112)
        self.assertEqual(status_only["details"]["direct_api_contract"]["openapi_marked_direct_write_control_count"], 88)
        self.assertEqual(status_only["details"]["direct_api_contract"]["non_get_openapi_marked_direct_count"], 88)
        ...
        self.assertEqual(status_only["details"]["browser_proxy_contract"]["browser_write_proxy_count"], 90)
        self.assertEqual(status_only["details"]["browser_proxy_contract"]["direct_write_control_count"], 88)
        ...
        self.assertEqual(status_only["details"]["openapi_contract"]["operation_request_body_count"], 53)
        ...
        self.assertEqual(status_only["details"]["openapi_contract"]["request_body_schema_ref_count"], 50)
        ...
        self.assertEqual(status_only["details"]["openapi_contract"]["write_control_operation_count"], 91)
        self.assertEqual(status_only["details"]["openapi_contract"]["direct_write_control_operation_count"], 88)
    ...
    def test_native_tooling_state_tracks_direct_api_contract_alignment(self):
        ...
        self.assertEqual(contract["openapi_marked_direct_write_control_count"], 88)
        self.assertEqual(
        ...
        self.assertEqual(contract["non_get_openapi_marked_direct_count"], 88)
        self.assertEqual(
    ...
    def test_native_tooling_state_tracks_browser_proxy_contract_alignment(self):
        ...
        self.assertEqual(contract["browser_write_proxy_count"], 90)
        self.assertEqual(contract["direct_write_control_count"], 88)
        ...
        normalized_gsad_writes = {
            turbovasctl.normalize_native_api_operation_template(operation)
        ...
        for override_write in (
            ...
            self.assertIn(
                turbovasctl.normalize_native_api_operation_template(override_write),
                normalized_gsad_writes,
            )
    ...
    def test_native_tooling_state_tracks_openapi_contract_alignment(self):
        ...
        self.assertEqual(contract["operation_count"], 203)
        ...
        expected_inherited_still_owns_values = ['credential-secret-updates-non-up-usk-types-and-deletes',
    ...
    def test_native_api_client_contract_is_generated_client_ready(self):
        ...
        self.assertEqual(details["operation_count"], 203)
        self.assertEqual(details["direct_operation_count"], 200)
    ...
    def test_native_api_client_contract_status_only_is_chat_safe(self):
        ...
        self.assertEqual(status_only["details"]["non_get_direct_operation_count"], 88)
        self.assertEqual(status_only["details"]["write_control_operation_count"], 91)
        self.assertEqual(status_only["details"]["direct_write_control_operation_count"], 88)
        self.assertEqual(status_only["details"]["operation_request_body_count"], 53)
    ...
    def test_native_api_migration_matrix_combines_inventory_and_openapi_metadata(self):
        ...
        self.assertEqual(result["status"], "pass")
        self.assertEqual(details["summary"]["total_rows"], 203)
        self.assertEqual(details["summary"]["openapi_operation_rows"], 203)
        self.assertEqual(details["summary"]["inventory_rows"], 203)
        self.assertEqual(details["summary"]["rows_with_checked_migration_metadata"], 203)
        self.assertEqual(details["summary"]["checked_migration_field_counts"]["x_turbovas_exposure"], 203)
        ...
        self.assertEqual(password_change["x_turbovas_exposure"], "browser-write")
        self.assertEqual(password_change["x_turbovas_replaces"], "user-current-password-change")
    ...
    def test_native_api_replacement_dashboard_calculates_weighted_estimate(self):
        ...
        with unittest.mock.patch.object(turbovasctl, "command_native_tooling_state", return_value=tooling), \
             ...
             unittest.mock.patch.object(turbovasctl, "legacy_component_source_teardown", return_value=source_teardown):
    ...
    def test_legacy_component_source_teardown_tracks_both_components(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            result = turbovasctl.legacy_component_source_teardown(root)
    ...
    def test_openapi_operation_id_generator_is_stable_and_collision_free(self):
        ...
        self.assertEqual(len(operation_ids), 203)
        ...
        self.assertEqual(
            turbovasctl.openapi_contract_operation_id("get", "/scan-configs/{scan_config_id}/backup"),
            "getScanConfigsByScanConfigIdBackup",
        )
        self.assertEqual(
            turbovasctl.openapi_contract_operation_id("post", "/scan-configs/import"),
...
""",
    ...
    def test_native_tooling_category_keeps_scripts_and_docs_distinct(self):
        ...
        self.assertEqual(turbovasctl.native_tooling_category("components/gsa/src/gmp/commands/overrides.js")[0], "compatibility_bridge")
        self.assertEqual(turbovasctl.native_tooling_category("components/gsa/src/gmp/commands/entity.ts")[0], "compatibility_bridge")
    ...
    def test_native_override_inventory_tracks_retained_native_contract(self):
        root = Path(__file__).resolve().parents[2]
        summary = turbovasctl.summarize_native_tooling([], root)
        rows = {
            (item.get("method", "get"), item["endpoint"]): item
        ...
        for key, row in rows.items():
            with self.subTest(operation=key):
                ...
                if key[0] != "get":
                    self.assertEqual(
                        turbovasctl.native_browser_proxy_operation_status(root, *key),
    ...
    def test_native_api_create_cleanup_state_marks_malformed_201_and_committed_502_uncertain(self):
        ...
        self.assertEqual(
            turbovasctl.native_api_cleanup_identity_predicate(
    ...
    def test_direct_admin_operator_uuid_uses_pinned_app_images(self):
        ...
        users = turbovasctl.subprocess.CompletedProcess(
            [], 0, f"admin {operator_uuid}\n", ""
        )

        with unittest.mock.patch.object(
            turbovasctl, "run_gvmd_oneoff", return_value=users
        ) as run_gvmd:
            result, parsed_uuid = turbovasctl.native_api_direct_admin_operator_uuid(
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            def fake_direct_curl(_root, path, *, method="GET", body=None, **_kwargs):
                ...
                if method == "GET" and path == "/api/v1/nvts?page_size=1&sort=oid":
                    return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps({"items": [{"id": override_nvt_id, "oid": override_nvt_id, "name": "fixture NVT"}], "page": {"total": 1}}) + "\n200", "")
                if method == "POST" and path == "/api/v1/overrides":
                    payload = json.loads(body)
                    self.assertEqual(payload, {"nvt_id": override_nvt_id, "text": f"turbovas-direct-write-smoke-override-1-{turbovasctl.os.getpid()}", "severity": 0.0, "new_severity": 4.2, "activation": {"mode": "inactive"}})
                    override_source_live["value"] = True
                    return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps({"id": override_uuid, "text": payload["text"], "new_severity": 4.2, "active": False}) + "\n201", "")
                if method == "PATCH" and path == f"/api/v1/overrides/{override_uuid}":
                    ...
                    return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps({"id": override_uuid, "new_severity": 4.3, "active": True}) + "\n200", "")
                if method == "POST" and path == f"/api/v1/overrides/{override_uuid}/clone":
                    self.assertEqual(json.loads(body), {})
                    override_clone_live["value"] = True
                    return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps({"id": override_clone_uuid, "text": f"turbovas-direct-write-smoke-override-1-{turbovasctl.os.getpid()}", "new_severity": 4.3}) + "\n201", "")
                if method == "POST" and path == f"/api/v1/overrides/{override_uuid}/restore":
                    override_source_live["value"] = True
                    return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps({"id": override_uuid, "text": f"turbovas-direct-write-smoke-override-1-{turbovasctl.os.getpid()}"}) + "\n200", "")
                ...
                if method == "GET" and path == f"/api/v1/overrides/{override_uuid}":
                    if override_source_live["value"]:
                        return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps({"id": override_uuid}) + "\n200", "")
                ...
                if method == "GET" and path == f"/api/v1/overrides/{override_clone_uuid}":
                    if override_clone_live["value"]:
                        return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps({"id": override_clone_uuid}) + "\n200", "")
                    return turbovasctl.subprocess.CompletedProcess([], 0, '{"error":{"code":"not_found"}}\n404', "")
                ...
                if method == "GET" and path == f"/api/v1/alerts/{alert_uuid}/definition":
                    return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps(alert_definition["value"]) + "\n200", "")
                ...
                if method == "POST" and path == "/api/v1/scan-configs/import":
                    ...
                    return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps({"id": scan_config_import_uuid, "comment": payload["comment"], "name": payload["name"], "predefined": False}) + "\n201", "")
                ...
                if method == "PATCH" and path.startswith(f"/api/v1/scan-configs/{scan_config_uuid}"):
                    ...
                    if "preferences" in payload:
                        for preference in payload["preferences"]:
                            if preference["name"] == "__turbovas_missing_preference__":
                                return turbovasctl.subprocess.CompletedProcess([], 0, '{"error":{"code":"not_found"}}\n404', "")
                ...
                if method == "GET" and path == f"/api/v1/scan-configs/{scan_config_import_uuid}":
                    if scan_config_import_live["value"]:
                        return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps({"id": scan_config_import_uuid}) + "\n200", "")
                    return turbovasctl.subprocess.CompletedProcess([], 0, '{"error":{"code":"not_found"}}\n404', "")
