...
| Rust operator CLI | Incremental migration | Rust implements 28 parity-tested subcommands across repository, assurance, runtime-inspection, guarded-refusal, immutable feed staging, and explicit opt-in operator actions; Python remains the compatibility entrypoint for the rest. |
