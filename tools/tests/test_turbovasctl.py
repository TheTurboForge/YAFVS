...
class TurboVASCtlTests(unittest.TestCase):
    ...
    def test_native_tooling_state_status_only_is_chat_safe(self):
        ...
        self.assertEqual(status_only["details"]["direct_api_contract"]["openapi_marked_direct_operation_count"], 112)
        self.assertEqual(status_only["details"]["direct_api_contract"]["openapi_marked_direct_read_operation_count"], 76)
        self.assertEqual(status_only["details"]["direct_api_contract"]["openapi_marked_direct_write_control_count"], 36)
        self.assertEqual(status_only["details"]["direct_api_contract"]["non_get_openapi_marked_direct_count"], 36)
        ...
        self.assertEqual(status_only["details"]["openapi_contract"]["write_control_operation_count"], 36)
        self.assertEqual(status_only["details"]["openapi_contract"]["direct_write_control_operation_count"], 36)
    ...
    def test_native_tooling_state_tracks_direct_api_contract_alignment(self):
        ...
        self.assertEqual(contract["openapi_marked_direct_write_control_count"], 36)
        self.assertEqual(
        ...
        self.assertEqual(contract["non_get_openapi_marked_direct_count"], 36)
        self.assertEqual(
    ...
    def test_native_tooling_state_tracks_openapi_contract_alignment(self):
        ...
        self.assertEqual(contract["operation_count"], 112)
        ...
        expected_inherited_still_owns_values = [
            ...
            "scan-config-preferences-selector-import-export-create-trash-hard-delete",
    ...
    def test_native_api_client_contract_status_only_is_chat_safe(self):
        ...
        self.assertEqual(status_only["details"]["non_get_direct_operation_count"], 36)
        self.assertEqual(status_only["details"]["write_control_operation_count"], 36)
        self.assertEqual(status_only["details"]["direct_write_control_operation_count"], 36)
    ...
    def test_native_api_migration_matrix_combines_inventory_and_openapi_metadata(self):
        ...
        self.assertEqual(result["status"], "pass")
        self.assertEqual(details["summary"]["total_rows"], 112)
        self.assertEqual(details["summary"]["openapi_operation_rows"], 112)
        self.assertEqual(details["summary"]["inventory_rows"], 112)
        self.assertEqual(details["summary"]["rows_with_checked_migration_metadata"], 112)
        self.assertEqual(details["summary"]["checked_migration_field_counts"]["x_turbovas_exposure"], 112)
        ...
        expected_asset_metadata = {
            ...
            "/api/v1/scan-configs": ("getScanConfigs", "scan-config-metadata-list-read", "scan-config-preferences-selector-import-export-create-trash-hard-delete"),
            "/api/v1/scan-configs/{scan_config_id}": ("getScanConfigsByScanConfigId", "scan-config-metadata-detail-info-tags-and-task-backlink-read", "scan-config-preferences-selector-import-export-create-trash-hard-delete"),
            "/api/v1/scan-configs/{scan_config_id}/families": ("getScanConfigsByScanConfigIdFamilies", "scan-config-family-summary-read", "scan-config-preferences-selector-import-export-create-trash-hard-delete"),
        }
    ...
    def test_openapi_operation_id_generator_is_stable_and_collision_free(self):
        ...
        self.assertEqual(len(operation_ids), 112)
    ...
    def test_openapi_tracks_direct_feed_security_information_and_alert_tag_lookup_contracts(self):
        ...
        expected_asset_metadata = [
            ...
            (scan_configs, "getScanConfigs", "scan-config-metadata-list-read", "scan-config-preferences-selector-import-export-create-trash-hard-delete"),
            (scan_config_detail, "getScanConfigsByScanConfigId", "scan-config-metadata-detail-info-tags-and-task-backlink-read", "scan-config-preferences-selector-import-export-create-trash-hard-delete"),
            (scan_config_families, "getScanConfigsByScanConfigIdFamilies", "scan-config-family-summary-read", "scan-config-preferences-selector-import-export-create-trash-hard-delete"),
        ]
