...
class TurboVASCtlTests(unittest.TestCase):
    ...
    def test_native_tooling_state_status_only_is_chat_safe(self):
        ...
        self.assertEqual(status_only["details"]["direct_api_contract"]["openapi_marked_direct_operation_count"], 102)
        self.assertEqual(status_only["details"]["direct_api_contract"]["openapi_marked_direct_read_operation_count"], 74)
        self.assertEqual(status_only["details"]["direct_api_contract"]["openapi_marked_direct_write_control_count"], 28)
        self.assertEqual(status_only["details"]["direct_api_contract"]["non_get_openapi_marked_direct_count"], 28)
        ...
        self.assertEqual(status_only["details"]["openapi_contract"]["operation_request_body_count"], 14)
        ...
        self.assertEqual(status_only["details"]["openapi_contract"]["write_control_operation_count"], 28)
        self.assertEqual(status_only["details"]["openapi_contract"]["direct_write_control_operation_count"], 28)
    ...
    def test_native_tooling_state_tracks_direct_api_contract_alignment(self):
        ...
        self.assertEqual(contract["openapi_marked_direct_write_control_count"], 28)
        self.assertEqual(
        ...
        self.assertEqual(contract["non_get_openapi_marked_direct_count"], 28)
        self.assertEqual(
    ...
    def test_native_tooling_state_tracks_openapi_contract_alignment(self):
        ...
        self.assertEqual(contract["operation_count"], 102)
    ...
    def test_native_api_client_contract_is_generated_client_ready(self):
        ...
        self.assertEqual(details["operation_count"], 102)
        self.assertEqual(details["direct_operation_count"], 102)
    ...
    def test_native_api_client_contract_status_only_is_chat_safe(self):
        ...
        self.assertEqual(status_only["details"]["non_get_direct_operation_count"], 28)
        self.assertEqual(status_only["details"]["write_control_operation_count"], 28)
        self.assertEqual(status_only["details"]["direct_write_control_operation_count"], 28)
        self.assertEqual(status_only["details"]["operation_request_body_count"], 14)
    ...
    def test_native_api_migration_matrix_combines_inventory_and_openapi_metadata(self):
        ...
        self.assertEqual(result["status"], "pass")
        self.assertEqual(details["summary"]["total_rows"], 102)
        self.assertEqual(details["summary"]["openapi_operation_rows"], 102)
        self.assertEqual(details["summary"]["inventory_rows"], 102)
        self.assertEqual(details["summary"]["rows_with_checked_migration_metadata"], 102)
        self.assertEqual(details["summary"]["checked_migration_field_counts"]["x_turbovas_exposure"], 102)
...
"""
    ...
    def test_direct_native_api_write_smoke_uses_guarded_operator_and_cleans_up(self):
        ...
        self.assertEqual([probe[0] for probe in probes], ["POST", "PATCH", "PATCH", "DELETE", "DELETE", "GET", "POST", "POST", "PATCH", "POST", "DELETE", "GET", "POST", "DELETE", "GET", "DELETE", "GET", "GET", "PATCH", "PATCH", "POST", "DELETE", "DELETE", "GET", "DELETE", "POST", "DELETE", "DELETE", "GET", "GET", "PATCH", "PATCH", "DELETE", "GET", "POST", "DELETE", "DELETE", "GET", "GET", "GET", "PATCH", "DELETE", "POST", "POST", "DELETE", "DELETE", "GET", "DELETE", "GET", "POST", "DELETE", "DELETE", "GET", "GET", "GET", "POST", "GET", "POST", "GET", "PATCH", "PATCH", "DELETE", "DELETE", "GET"])
        rendered = json.dumps(result, sort_keys=True)
        self.assertNotIn(token, rendered)
