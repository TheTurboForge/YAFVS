...
#[test]
fn native_direct_api_allows_schedule_create_and_metadata_writes_under_write_control() {
...
#[test]
fn openapi_documents_schedule_create_metadata_patch_and_trash_move_boundary() {
