...
use crate::{
    ...
    browser_proxy_api::{
        BrowserProxyAuth, browser_proxy_clone_filter, browser_proxy_clone_scan_config,
        browser_proxy_clone_tag, browser_proxy_clone_target, browser_proxy_create_filter,
        browser_proxy_create_scan_config, browser_proxy_create_scope, browser_proxy_create_tag,
        browser_proxy_create_target, browser_proxy_delete_filter, browser_proxy_delete_scan_config,
        browser_proxy_delete_scope, browser_proxy_delete_tag, browser_proxy_delete_target,
        browser_proxy_hard_delete_filter, browser_proxy_hard_delete_scan_config,
        browser_proxy_hard_delete_tag, browser_proxy_hard_delete_target, browser_proxy_patch_alert,
        browser_proxy_patch_credential, browser_proxy_patch_filter,
        browser_proxy_patch_scan_config, browser_proxy_patch_scanner, browser_proxy_patch_scope,
        browser_proxy_patch_tag, browser_proxy_patch_target, browser_proxy_patch_task,
        browser_proxy_restore_filter, browser_proxy_restore_scan_config, browser_proxy_restore_tag,
        browser_proxy_restore_target, browser_proxy_update_tag_resources,
    },
