...
Ensure (gsad_validator, reject_removed_native_only_commands)
{
  ...
  assert_that (gvm_validate (validator, "cmd", "get_nvt_families"),
               is_equal_to (2));
  assert_that (gvm_validate (validator, "cmd", "get_feeds"),
               is_equal_to (2));
  assert_that (gvm_validate (validator, "cmd", "get_license"),
               is_equal_to (2));
  assert_that (gvm_validate (validator, "cmd", "save_license"),
               is_equal_to (2));
  ...
  assert_that (gvm_validate (validator, "cmd", "get_credentials"),
               is_equal_to (2));
  assert_that (gvm_validate (validator, "cmd", "export_credential"),
               is_equal_to (2));
  ...
  assert_that (gvm_validate (validator, "cmd", "get_targets"),
               is_equal_to (2));
  assert_that (gvm_validate (validator, "cmd", "export_target"),
               is_equal_to (2));
  assert_that (gvm_validate (validator, "cmd", "export_targets"),
               is_equal_to (2));
  assert_that (gvm_validate (validator, "cmd", "create_target"),
               is_equal_to (2));
  assert_that (gvm_validate (validator, "cmd", "save_target"),
               is_equal_to (2));
  ...
  assert_that (gvm_validate (validator, "cmd", "get_tls_certificates"),
               is_equal_to (2));
  assert_that (gvm_validate (validator, "cmd", "create_tls_certificate"),
               is_equal_to (2));
  assert_that (gvm_validate (validator, "cmd", "delete_tls_certificate"),
               is_equal_to (2));
  assert_that (gvm_validate (validator, "cmd", "save_tls_certificate"),
               is_equal_to (2));
...
{
  validator_t validator = gsad_get_validator ();
  assert_that (gvm_validate (validator, "cmd", "report_alert"),
               is_equal_to (2));
}
