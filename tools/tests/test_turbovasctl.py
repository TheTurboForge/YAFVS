...
class TurboVASCtlTests(unittest.TestCase):
    ...
    def test_browser_native_api_readiness_accepts_data_aware_smoke_warnings(self):
        ...
        with unittest.mock.patch.object(
            ...
            item = turbovasctl.browser_native_api_readiness_finding(
    ...
    def test_native_tooling_state_classifies_dependency_surfaces(self):
        ...
        self.assertIn("tools/tests/test_turbovasctl.py", details["by_category"]["compatibility_bridge"]["paths"])
    ...
    def test_native_tooling_state_status_only_is_chat_safe(self):
        ...
        self.assertEqual(status_only["details"]["direct_api_contract"]["openapi_marked_direct_operation_count"], 184)
        self.assertEqual(status_only["details"]["direct_api_contract"]["openapi_marked_direct_read_operation_count"], 107)
        self.assertEqual(status_only["details"]["direct_api_contract"]["openapi_marked_direct_write_control_count"], 77)
        self.assertEqual(status_only["details"]["direct_api_contract"]["non_get_openapi_marked_direct_count"], 77)
        ...
        self.assertEqual(status_only["details"]["browser_proxy_contract"]["browser_write_proxy_count"], 76)
        self.assertEqual(status_only["details"]["browser_proxy_contract"]["direct_write_control_count"], 77)
        ...
        self.assertEqual(status_only["details"]["openapi_contract"]["operation_request_body_count"], 41)
        ...
        self.assertEqual(status_only["details"]["openapi_contract"]["request_body_schema_ref_count"], 41)
        ...
        self.assertEqual(status_only["details"]["openapi_contract"]["write_control_operation_count"], 77)
        self.assertEqual(status_only["details"]["openapi_contract"]["direct_write_control_operation_count"], 77)
    ...
    def test_native_tooling_state_tracks_direct_api_contract_alignment(self):
        ...
        self.assertEqual(contract["openapi_marked_direct_write_control_count"], 77)
        self.assertEqual(
        ...
        self.assertEqual(contract["non_get_openapi_marked_direct_count"], 77)
        self.assertEqual(
    ...
    def test_native_tooling_state_tracks_browser_proxy_contract_alignment(self):
        ...
        self.assertEqual(contract["browser_write_proxy_count"], 76)
        self.assertEqual(contract["direct_write_control_count"], 77)
        ...
        self.assertIn("PATCH /api/v1/report-configs/{report_config_id}", contract["browser_write_proxy_operations"])
    ...
    def test_native_tooling_state_parses_browser_post_proxy_boundary(self):
        endpoints = [
            ...
            {
                "endpoint": "/api/v1/filters/{filter_id}",
                "method": "patch",
                "status": "implemented_internal_and_browser_proxied",
                "direct_access": "direct_write_control",
            },
            {
                "endpoint": "/api/v1/filters/{filter_id}/clone",
                "method": "post",
                "status": "implemented_internal_and_browser_proxied",
                "direct_access": "direct_write_control",
            },
            {
                "endpoint": "/api/v1/port-lists",
                "method": "post",
                "status": "implemented_internal_and_browser_proxied",
                "direct_access": "direct_write_control",
            },
            {
                "endpoint": "/api/v1/port-lists/{port_list_id}/clone",
                "method": "post",
                "status": "implemented_internal_and_browser_proxied",
                "direct_access": "direct_write_control",
            },
            {
                "endpoint": "/api/v1/port-lists/{port_list_id}",
                "method": "patch",
                "status": "implemented_internal_and_browser_proxied",
                "direct_access": "direct_write_control",
            },
            {
                "endpoint": "/api/v1/port-list-imports",
                "method": "post",
                "status": "implemented_internal_and_browser_proxied",
                "direct_access": "direct_write_control",
            },
            {
                "endpoint": "/api/v1/tags/{tag_id}/clone",
                "method": "post",
                "status": "implemented_internal_and_browser_proxied",
                "direct_access": "direct_write_control",
            },
            ...
            {
                "endpoint": "/api/v1/report-configs/{report_config_id}",
                "method": "patch",
                "status": "implemented_internal_and_browser_proxied",
                "direct_access": "direct_write_control",
            },
            ...
            {
                "endpoint": "/api/v1/scan-configs/{scan_config_id}",
                "method": "patch",
                "status": "implemented_internal_and_browser_proxied",
                "direct_access": "direct_write_control",
            },
            {
                "endpoint": "/api/v1/scan-configs/{scan_config_id}/clone",
                "method": "post",
                "status": "implemented_internal_and_browser_proxied",
                "direct_access": "direct_write_control",
            },
            {
                "endpoint": "/api/v1/scan-configs/{scan_config_id}/diagnostic-nvt-selection",
                "method": "post",
                "status": "implemented_internal_only",
                "direct_access": "direct_write_control",
            },
            {
                "endpoint": "/api/v1/scanners/{scanner_id}",
                "method": "patch",
                "status": "implemented_internal_and_browser_proxied",
                "direct_access": "direct_write_control",
            },
            ...
            {
                "endpoint": "/api/v1/schedules/{schedule_id}",
                "method": "patch",
                "status": "implemented_internal_and_browser_proxied",
                "direct_access": "direct_write_control",
            },
            ...
            {
                "endpoint": "/api/v1/targets/{target_id}",
                "method": "patch",
                "status": "implemented_internal_and_browser_proxied",
                "direct_access": "direct_write_control",
            },
            {
                "endpoint": "/api/v1/targets/{target_id}/clone",
                "method": "post",
                "status": "implemented_internal_and_browser_proxied",
                "direct_access": "direct_write_control",
            },
    ...
    def test_native_tooling_state_tracks_openapi_contract_alignment(self):
        ...
        self.assertEqual(contract["operation_count"], 184)
        ...
        self.assertEqual(
            ...
            ["POST /hosts", "PATCH /hosts/{host_id}", "PATCH /scanners/{scanner_id}", "POST /credentials", "PATCH /credentials/{credential_id}", "POST /filters", "PATCH /filters/{filter_id}", "POST /filters/{filter_id}/clone", "POST /alerts", "PATCH /alerts/{alert_id}", "POST /alerts/{alert_id}/clone", "POST /tags", "PATCH /tags/{tag_id}", "POST /tags/{tag_id}/clone", "POST /tags/{tag_id}/resources", "POST /port-lists", "POST /port-list-imports", "PATCH /port-lists/{port_list_id}", "POST /port-lists/{port_list_id}/ranges", "POST /port-lists/{port_list_id}/clone", "POST /schedules", "PATCH /schedules/{schedule_id}", "POST /schedules/{schedule_id}/clone", "POST /scan-configs", "PATCH /scan-configs/{scan_config_id}", "POST /scan-configs/{scan_config_id}/diagnostic-nvt-selection", "POST /scan-configs/{scan_config_id}/clone", "POST /report-configs", "PATCH /report-configs/{report_config_id}", "POST /report-configs/{report_config_id}/clone", "PATCH /report-formats/{report_format_id}", "POST /trashcan/empty", "POST /scopes", "PATCH /scopes/{scope_id}", "POST /targets", "PATCH /targets/{target_id}", "POST /targets/{target_id}/clone", "POST /tasks", "PATCH /tasks/{task_id}"],
        )
        ...
        expected_inherited_still_owns_values = ['alert-other-methods-test-actions-and-delivery-payload-mutations',
         ...
         'task-resume-file-hard-delete-and-other-scanner-control',
    ...
    def test_native_api_client_contract_is_generated_client_ready(self):
        ...
        self.assertEqual(details["operation_count"], 184)
        self.assertEqual(details["direct_operation_count"], 184)
        ...
        self.assertEqual(
            ...
            ["POST /hosts", "PATCH /hosts/{host_id}", "DELETE /hosts/{host_id}", "DELETE /host-identifiers/{identifier_id}", "DELETE /host-operating-systems/{host_operating_system_id}", "DELETE /tls-certificates/{certificate_id}", "PATCH /scanners/{scanner_id}", "POST /scanners/{scanner_id}/verify", "POST /credentials", "PATCH /credentials/{credential_id}", "POST /filters", "PATCH /filters/{filter_id}", "DELETE /filters/{filter_id}", "POST /filters/{filter_id}/clone", "POST /filters/{filter_id}/restore", "DELETE /filters/{filter_id}/trash", "POST /alerts", "PATCH /alerts/{alert_id}", "DELETE /alerts/{alert_id}", "POST /alerts/{alert_id}/clone", "POST /tags", "PATCH /tags/{tag_id}", "DELETE /tags/{tag_id}", "POST /tags/{tag_id}/clone", "POST /tags/{tag_id}/restore", "DELETE /tags/{tag_id}/trash", "POST /tags/{tag_id}/resources", "DELETE /overrides/{override_id}", "POST /port-lists", "POST /port-list-imports", "PATCH /port-lists/{port_list_id}", "DELETE /port-lists/{port_list_id}", "POST /port-lists/{port_list_id}/ranges", "DELETE /port-lists/{port_list_id}/ranges/{port_range_id}", "POST /port-lists/{port_list_id}/clone", "POST /port-lists/{port_list_id}/restore", "DELETE /port-lists/{port_list_id}/trash", "POST /schedules", "PATCH /schedules/{schedule_id}", "DELETE /schedules/{schedule_id}", "POST /schedules/{schedule_id}/clone", "POST /schedules/{schedule_id}/restore", "DELETE /schedules/{schedule_id}/trash", "POST /scan-configs", "PATCH /scan-configs/{scan_config_id}", "DELETE /scan-configs/{scan_config_id}", "POST /scan-configs/{scan_config_id}/diagnostic-nvt-selection", "POST /scan-configs/{scan_config_id}/clone", "POST /scan-configs/{scan_config_id}/restore", "DELETE /scan-configs/{scan_config_id}/trash", "POST /report-configs", "PATCH /report-configs/{report_config_id}", "DELETE /report-configs/{report_config_id}", "POST /report-configs/{report_config_id}/clone", "POST /report-configs/{report_config_id}/restore", "DELETE /report-configs/{report_config_id}/trash", "PATCH /report-formats/{report_format_id}", "POST /trashcan/empty", "POST /scopes", "PATCH /scopes/{scope_id}", "DELETE /scopes/{scope_id}", "POST /scopes/{scope_id}/reports", "POST /targets", "PATCH /targets/{target_id}", "DELETE /targets/{target_id}", "POST /targets/{target_id}/clone", "POST /targets/{target_id}/restore", "DELETE /targets/{target_id}/trash", "POST /tasks", "PATCH /tasks/{task_id}", "DELETE /tasks/{task_id}", "POST /tasks/{task_id}/clone", "POST /tasks/{task_id}/start", "POST /tasks/{task_id}/stop", "DELETE /scope-reports/{scope_report_id}"],
        )
    ...
    def test_native_api_client_contract_status_only_is_chat_safe(self):
        ...
        self.assertEqual(status_only["details"]["non_get_direct_operation_count"], 77)
        self.assertEqual(status_only["details"]["write_control_operation_count"], 77)
        self.assertEqual(status_only["details"]["direct_write_control_operation_count"], 77)
        self.assertEqual(status_only["details"]["operation_request_body_count"], 41)
    ...
    def test_native_api_migration_matrix_combines_inventory_and_openapi_metadata(self):
        ...
        self.assertEqual(result["status"], "pass")
        self.assertEqual(details["summary"]["total_rows"], 184)
        self.assertEqual(details["summary"]["openapi_operation_rows"], 184)
        self.assertEqual(details["summary"]["inventory_rows"], 184)
        self.assertEqual(details["summary"]["rows_with_checked_migration_metadata"], 184)
        self.assertEqual(details["summary"]["checked_migration_field_counts"]["x_turbovas_exposure"], 184)
        ...
        self.assertEqual(task_clone["x_turbovas_maturity"], "live-write")
        self.assertEqual(task_clone["x_turbovas_exposure"], "direct-write")
        self.assertEqual(task_clone["x_turbovas_replaces"], "task-clone")
        self.assertEqual(task_clone["x_turbovas_side_effect"], "scanner-control")
        self.assertIsNone(task_clone["x_turbovas_inherited_still_owns"])
        self.assertIn("Task resume, hard-delete", source)
        ...
        self.assertEqual(create_port_list_range["x_turbovas_maturity"], "live-write")
        self.assertEqual(create_port_list_range["x_turbovas_exposure"], "direct-write")
        self.assertEqual(create_port_list_range["x_turbovas_replaces"], "port-list-range-create")
        ...
        self.assertEqual(delete_port_list_range["x_turbovas_maturity"], "live-write")
        self.assertEqual(delete_port_list_range["x_turbovas_exposure"], "direct-write")
        self.assertEqual(delete_port_list_range["x_turbovas_replaces"], "port-list-range-delete")
        ...
        self.assertEqual(import_port_list["x_turbovas_maturity"], "live-write")
        self.assertEqual(import_port_list["x_turbovas_exposure"], "direct-write")
        self.assertEqual(import_port_list["x_turbovas_replaces"], "port-list-import")
        ...
        self.assertEqual(patch_schedule["x_turbovas_replaces"], "schedule-metadata-modify")
        ...
        self.assertEqual(patch_filter["x_turbovas_maturity"], "live-write")
        self.assertEqual(patch_filter["x_turbovas_exposure"], "direct-write")
        ...
        self.assertEqual(patch_report_config["status"], "implemented_internal_and_browser_proxied")
        ...
        self.assertEqual(clone_report_config["status"], "implemented_internal_and_browser_proxied")
        ...
        self.assertIsNone(scope_reports["x_turbovas_inherited_still_owns"])
        ...
        self.assertIsNone(scope_report_detail["x_turbovas_inherited_still_owns"])
        ...
        self.assertEqual(scope_report_results_by_id["x_turbovas_exposure"], "direct-read")
        self.assertEqual(scope_report_results_by_id["x_turbovas_maturity"], "live-read")
        self.assertEqual(scope_report_results_by_id["x_turbovas_replaces"], "scope-report-result-evidence-read")
        self.assertIsNone(scope_report_results_by_id["x_turbovas_inherited_still_owns"])
        ...
        rows = [
            {
                ...
                "x_turbovas_inherited_still_owns": "schedule-calendar-edit-and-task-recalculation",
    ...
    def test_native_start_task_requires_write_control_before_runtime(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with unittest.mock.patch.object(turbovasctl, "direct_native_api_curl") as curl:
                result = turbovasctl.command_native_start_task(root, task_id=task_id)
                curl.assert_not_called()
    ...
    def test_native_stop_task_requires_write_control_before_runtime(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            root = Path(tmp)
            with unittest.mock.patch.object(turbovasctl, "direct_native_api_curl") as curl:
                result = turbovasctl.command_native_stop_task(root, task_id=task_id)
                curl.assert_not_called()
    ...
    def test_native_stop_task_rejects_incomplete_requested_acknowledgement(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with unittest.mock.patch.object(turbovasctl, "native_api_direct_runtime_env", return_value={}), \
                ...
                unittest.mock.patch.object(turbovasctl, "direct_native_api_curl", return_value=response) as curl:
                result = turbovasctl.command_native_stop_task(
                    root,
                    task_id=task_id,
                    allow_write_control=True,
                    status_only=True,
    ...
    def test_native_start_task_calls_guarded_direct_endpoint_and_summarizes_acknowledgement(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with unittest.mock.patch.object(turbovasctl, "native_api_direct_runtime_env", return_value={}), \
                ...
                unittest.mock.patch.object(turbovasctl, "native_api_direct_bearer_token", return_value="a" * 64), \
                unittest.mock.patch.object(turbovasctl, "direct_native_api_curl", return_value=response) as curl:
                result = turbovasctl.command_native_start_task(
                    root,
                    task_id=task_id,
                    allow_write_control=True,
                    status_only=True,
    ...
    def _native_scan_new_system_result(
        self,
        *,
        start_response: subprocess.CompletedProcess[str] | None = None,
        follow_up_response: subprocess.CompletedProcess[str] | None = None,
        task_response: subprocess.CompletedProcess[str] | None = None,
    ) -> tuple[dict[str, object], list[tuple[str, str]], dict[str, str]]:
        ids = {
        ...
        def fake_direct(_root, path, **kwargs):
            ...
            if method == "POST" and path == "/api/v1/targets":
                ...
                self.assertEqual(body["hosts"], ["192.0.2.10"])
                self.assertEqual(body["alive_tests"], ["Scan Config Default"])
                self.assertFalse(body["allow_simultaneous_ips"])
                self.assertFalse(body["reverse_lookup_only"])
                self.assertFalse(body["reverse_lookup_unify"])
                return subprocess.CompletedProcess(["curl"], 0, json.dumps({"id": ids["target"], "name": body["name"]}) + "\n201", "")
            if method == "POST" and path == "/api/v1/tasks":
                if task_response is not None:
                    return task_response
                body = json.loads(kwargs["body"])
                self.assertEqual(body["target_id"], ids["target"])
                self.assertEqual(body["config_id"], turbovasctl.FULL_AND_FAST_SCAN_CONFIG_ID)
                self.assertEqual(body["scanner_id"], turbovasctl.NATIVE_SCAN_NEW_SYSTEM_DEFAULT_SCANNER_ID)
                return subprocess.CompletedProcess(["curl"], 0, json.dumps({"id": ids["task"], "name": body["name"]}) + "\n201", "")
            ...
            if method == "DELETE" and path == f"/api/v1/targets/{ids['target']}":
                return subprocess.CompletedProcess(["curl"], 0, "{}\n204", "")
            if method == "DELETE" and path == f"/api/v1/targets/{ids['target']}/trash":
                return subprocess.CompletedProcess(["curl"], 0, "{}\n204", "")
        ...
        with tempfile.TemporaryDirectory() as tmp:
            with unittest.mock.patch.object(turbovasctl, "native_api_direct_runtime_env", return_value={}), \
                ...
                result = turbovasctl.command_native_scan_new_system(Path(tmp), host="192.0.2.10", allow_scan_control=True)
        return result, calls, ids

    def test_native_scan_new_system_rejects_invalid_arguments_and_preflight_before_writes(self):
        with tempfile.TemporaryDirectory() as tmp:
            with unittest.mock.patch.object(turbovasctl, "direct_native_api_curl") as curl:
                invalid = turbovasctl.command_native_scan_new_system(Path(tmp), host="192.0.2.0/24", allow_scan_control=True)
                curl.assert_not_called()
        self.assertEqual(invalid["status"], "fail")
        self.assertEqual(invalid["findings"][0]["check"], "native-scan-new-system.arguments")

        calls: list[tuple[str, str]] = []
        def fake_direct(_root, path, **kwargs):
            calls.append((kwargs.get("method", "GET"), path))
            if path.endswith("/port-lists/" + turbovasctl.IANA_TCP_UDP_PORT_LIST_ID):
                payload = {"id": turbovasctl.IANA_TCP_UDP_PORT_LIST_ID, "name": "IANA"}
            elif path.endswith("/scan-configs/" + turbovasctl.FULL_AND_FAST_SCAN_CONFIG_ID):
                payload = {"id": turbovasctl.FULL_AND_FAST_SCAN_CONFIG_ID, "name": "Full and fast"}
            else:
                payload = {"id": turbovasctl.NATIVE_SCAN_NEW_SYSTEM_DEFAULT_SCANNER_ID, "name": "Not a task scanner", "scanner_type": 3}
        ...
        with tempfile.TemporaryDirectory() as tmp:
            with unittest.mock.patch.object(turbovasctl, "native_api_direct_runtime_env", return_value={}), \
                ...
                result = turbovasctl.command_native_scan_new_system(Path(tmp), host="192.0.2.10", allow_scan_control=True)
        self.assertEqual(result["status"], "fail")
        self.assertEqual([method for method, _path in calls], ["GET", "GET", "GET"])
        self.assertEqual(next(item for item in result["findings"] if item["check"].endswith("preflight.scanner"))["status"], "fail")

    def test_native_scan_new_system_dry_run_plans_without_writes(self):
        with tempfile.TemporaryDirectory() as tmp:
            with unittest.mock.patch.object(turbovasctl, "direct_native_api_curl") as curl:
                result = turbovasctl.command_native_scan_new_system(Path(tmp), host="2001:db8::10", dry_run=True)
                curl.assert_not_called()
        self.assertEqual(result["status"], "pass")
        self.assertEqual(result["details"]["status"], "dry_run")
        self.assertEqual(result["details"]["operation_status"], "dry_run")
        self.assertEqual(result["details"]["planned_target"]["hosts"], ["2001:db8::10"])
        self.assertEqual(result["details"]["planned_task"]["target_id"], "<created-target-id>")

    def test_native_scan_new_system_preflights_then_creates_and_starts_in_order(self):
        result, calls, ids = self._native_scan_new_system_result()
        self.assertEqual(result["status"], "pass")
        self.assertEqual(result["details"]["status"], "requested")
        self.assertEqual(result["details"]["operation_status"], "requested")
        self.assertEqual(result["details"]["target_id"], ids["target"])
        self.assertEqual(result["details"]["task_id"], ids["task"])
        self.assertEqual(result["details"]["report_id"], ids["report"])
        self.assertEqual(calls, [("GET", f"/api/v1/port-lists/{turbovasctl.IANA_TCP_UDP_PORT_LIST_ID}"), ("GET", f"/api/v1/scan-configs/{turbovasctl.FULL_AND_FAST_SCAN_CONFIG_ID}"), ("GET", f"/api/v1/scanners/{turbovasctl.NATIVE_SCAN_NEW_SYSTEM_DEFAULT_SCANNER_ID}"), ("POST", "/api/v1/targets"), ("POST", "/api/v1/tasks"), ("POST", f"/api/v1/tasks/{ids['task']}/start")])

    def test_native_scan_new_system_cleans_up_target_after_task_create_failure(self):
        result, calls, ids = self._native_scan_new_system_result(task_response=subprocess.CompletedProcess(["curl"], 0, '{"error":{"code":"conflict"}}\n409', ""))
        self.assertEqual(result["status"], "fail")
        self.assertEqual(result["details"]["target_id"], ids["target"])
        self.assertIsNone(result["details"]["task_id"])
        self.assertEqual(result["details"]["cleanup"]["live_delete"], "deleted")
        self.assertEqual(result["details"]["cleanup"]["trash_hard_delete"], "deleted")
        self.assertEqual(calls[-2:], [("DELETE", f"/api/v1/targets/{ids['target']}"), ("DELETE", f"/api/v1/targets/{ids['target']}/trash")])

    def test_native_scan_new_system_retains_ids_after_proven_inactive_start_failure(self):
        start = subprocess.CompletedProcess(["curl"], 0, '{"error":{"code":"conflict"}}\n409', "")
        inactive = subprocess.CompletedProcess(["curl"], 0, '{"id":"22222222-2222-4222-8222-222222222222","status":"New","current_report":null}\n200', "")
        result, calls, ids = self._native_scan_new_system_result(start_response=start, follow_up_response=inactive)
        self.assertEqual(result["status"], "fail")
        self.assertEqual(result["details"]["status"], "prepared_not_started")
        ...
        self.assertEqual(calls[-1], ("GET", f"/api/v1/tasks/{ids['task']}"))

    def test_native_scan_new_system_reports_unconfirmed_active_start_follow_up(self):
        start = subprocess.CompletedProcess(["curl"], 0, '{"error":{"code":"gateway_timeout"}}\n504', "")
        active = subprocess.CompletedProcess(["curl"], 0, '{"id":"22222222-2222-4222-8222-222222222222","status":"Running","current_report":{"id":"33333333-3333-4333-8333-333333333333"}}\n200', "")
        result, calls, ids = self._native_scan_new_system_result(start_response=start, follow_up_response=active)
        self.assertEqual(result["details"]["operation_status"], "start_outcome_unconfirmed")
        self.assertEqual(result["details"]["status"], "start_outcome_unconfirmed")
        self.assertEqual(result["details"]["observed_task_status"], "Running")
        self.assertEqual(result["details"]["report_id"], ids["report"])
        self.assertNotIn(("DELETE", f"/api/v1/targets/{ids['target']}"), calls)

    def test_native_scan_new_system_reports_unconfirmed_ambiguous_start_follow_up(self):
        start = subprocess.CompletedProcess(["curl"], 1, "", "timeout")
        unavailable = subprocess.CompletedProcess(["curl"], 22, "", "unavailable")
        result, calls, ids = self._native_scan_new_system_result(start_response=start, follow_up_response=unavailable)
        self.assertEqual(result["details"]["operation_status"], "start_outcome_unconfirmed")
        self.assertIsNone(result["details"]["observed_task_status"])
        self.assertIsNone(result["details"]["report_id"])
        self.assertNotIn(("DELETE", f"/api/v1/targets/{ids['target']}"), calls)

    def test_native_scan_new_system_parser_is_registered(self):
        args = turbovasctl.build_parser().parse_args(["native-scan-new-system", "--host", "192.0.2.10", "--dry-run"])
        self.assertEqual(args.command, "native-scan-new-system")
        self.assertEqual(args.port_list_id, turbovasctl.IANA_TCP_UDP_PORT_LIST_ID)
        self.assertEqual(args.scan_config_id, turbovasctl.FULL_AND_FAST_SCAN_CONFIG_ID)
        self.assertEqual(args.scanner_id, turbovasctl.NATIVE_SCAN_NEW_SYSTEM_DEFAULT_SCANNER_ID)
    ...
    def test_native_nvt_diagnostic_scan_defaults_to_empty_and_dry_runs_without_runtime_access(self):
        with tempfile.TemporaryDirectory() as tmp:
            with unittest.mock.patch.object(turbovasctl, "native_api_direct_runtime_env") as runtime_env, \
                ...
                result = turbovasctl.command_native_nvt_diagnostic_scan(
                    Path(tmp),
                    host="192.0.2.10",
                    nvt_id="1.3.6.1.4.1.25623.1.0.106223",
                )
        runtime_env.assert_not_called()
        curl.assert_not_called()
        self.assertEqual(result["status"], "pass")
        self.assertEqual(result["details"]["status"], "dry_run")
        self.assertEqual(result["details"]["source_scan_config_id"], turbovasctl.EMPTY_SCAN_CONFIG_ID)
        self.assertEqual(
            result["details"]["planned_selection"]["prerequisite_nvt_ids"],
            list(turbovasctl.NATIVE_NVT_DIAGNOSTIC_PREREQUISITE_IDS),
        )

    def test_native_nvt_diagnostic_scan_rejects_invalid_inputs_before_runtime(self):
        with tempfile.TemporaryDirectory() as tmp:
            with unittest.mock.patch.object(turbovasctl, "direct_native_api_curl") as curl:
                result = turbovasctl.command_native_nvt_diagnostic_scan(
                    Path(tmp),
        ...
        curl.assert_not_called()
        self.assertEqual(result["status"], "fail")
        self.assertEqual(result["findings"][0]["check"], "native-nvt-diagnostic-scan.arguments")

    def test_native_nvt_diagnostic_scan_preflights_clones_selects_creates_and_starts(self):
        ids = {
        ...
        def fake_direct(_root, path, **kwargs):
            method = kwargs.get("method", "GET")
            calls.append((method, path))
            if method == "GET" and path == "/api/v1/nvts/1.3.6.1.4.1.25623.1.0.106223":
                return subprocess.CompletedProcess(["curl"], 0, json.dumps({"id": "1.3.6.1.4.1.25623.1.0.106223", "name": "Diagnostic NVT"}) + "\n200", "")
            if method == "GET" and path == f"/api/v1/scan-configs/{turbovasctl.EMPTY_SCAN_CONFIG_ID}":
                return subprocess.CompletedProcess(["curl"], 0, json.dumps({"id": turbovasctl.EMPTY_SCAN_CONFIG_ID, "name": "Empty", "predefined": True, "writable": False, "in_use": False}) + "\n200", "")
            if method == "GET" and path == f"/api/v1/port-lists/{turbovasctl.IANA_TCP_UDP_PORT_LIST_ID}":
                return subprocess.CompletedProcess(["curl"], 0, json.dumps({"id": turbovasctl.IANA_TCP_UDP_PORT_LIST_ID, "name": "IANA"}) + "\n200", "")
            if method == "GET" and path == f"/api/v1/scanners/{turbovasctl.NATIVE_SCAN_NEW_SYSTEM_DEFAULT_SCANNER_ID}":
                return subprocess.CompletedProcess(["curl"], 0, json.dumps({"id": turbovasctl.NATIVE_SCAN_NEW_SYSTEM_DEFAULT_SCANNER_ID, "name": "OpenVAS", "scanner_type": 2}) + "\n200", "")
            if method == "POST" and path.endswith("/clone"):
                body = json.loads(kwargs["body"])
                return subprocess.CompletedProcess(["curl"], 0, json.dumps({"id": ids["config"], "name": body["name"]}) + "\n201", "")
            if method == "POST" and path.endswith("/diagnostic-nvt-selection"):
                body = json.loads(kwargs["body"])
                self.assertEqual(body, {"nvt_id": "1.3.6.1.4.1.25623.1.0.106223"})
                return subprocess.CompletedProcess(["curl"], 0, json.dumps({"config_id": ids["config"], "nvt_id": body["nvt_id"], "status": "selected"}) + "\n200", "")
            if method == "POST" and path == "/api/v1/targets":
                body = json.loads(kwargs["body"])
                return subprocess.CompletedProcess(["curl"], 0, json.dumps({"id": ids["target"], "name": body["name"]}) + "\n201", "")
            if method == "POST" and path == "/api/v1/tasks":
                ...
                return subprocess.CompletedProcess(["curl"], 0, json.dumps({"id": ids["task"], "name": body["name"]}) + "\n201", "")
            if method == "POST" and path == f"/api/v1/tasks/{ids['task']}/start":
                return subprocess.CompletedProcess(["curl"], 0, json.dumps({"task_id": ids["task"], "report_id": ids["report"], "status": "requested"}) + "\n202", "")
            raise AssertionError((method, path))
        ...
        with tempfile.TemporaryDirectory() as tmp:
            with unittest.mock.patch.object(turbovasctl, "native_api_direct_runtime_env", return_value={turbovasctl.TURBOVAS_API_OPERATOR_UUID_ENV: ids["operator"]}), \
                ...
                result = turbovasctl.command_native_nvt_diagnostic_scan(
                    ...
                    host="192.0.2.10",
                    nvt_id="1.3.6.1.4.1.25623.1.0.106223",
                    allow_scan_control=True,
                )
        self.assertEqual(result["status"], "pass")
        self.assertEqual(result["details"]["status"], "requested")
        self.assertEqual(result["details"]["scan_config_id"], ids["config"])
        self.assertEqual(result["details"]["target_id"], ids["target"])
        self.assertEqual(result["details"]["task_id"], ids["task"])
        self.assertEqual(result["details"]["report_id"], ids["report"])
        self.assertEqual(
            ...
            [
                ...
                ("GET", f"/api/v1/scan-configs/{turbovasctl.EMPTY_SCAN_CONFIG_ID}"),
                ("GET", f"/api/v1/port-lists/{turbovasctl.IANA_TCP_UDP_PORT_LIST_ID}"),
                ("GET", f"/api/v1/scanners/{turbovasctl.NATIVE_SCAN_NEW_SYSTEM_DEFAULT_SCANNER_ID}"),
            ],
        )
        self.assertIn(("POST", "/api/v1/targets"), calls)
        self.assertIn(("POST", "/api/v1/tasks"), calls)

    def test_native_nvt_diagnostic_scan_cleans_config_and_target_after_proven_task_failure(self):
        ids = {
            "config": "11111111-1111-4111-8111-111111111111",
            "target": "22222222-2222-4222-8222-222222222222",
            "operator": "55555555-5555-4555-8555-555555555555",
        ...
        def fake_direct(_root, path, **kwargs):
            method = kwargs.get("method", "GET")
            if method == "GET" and "/nvts/" in path:
                return subprocess.CompletedProcess(["curl"], 0, json.dumps({"id": "1.3.6.1.4.1.25623.1.0.106223", "name": "Diagnostic NVT"}) + "\n200", "")
            if method == "GET" and path.endswith(f"/scan-configs/{turbovasctl.EMPTY_SCAN_CONFIG_ID}"):
                return subprocess.CompletedProcess(["curl"], 0, json.dumps({"id": turbovasctl.EMPTY_SCAN_CONFIG_ID, "name": "Empty", "predefined": True, "writable": False, "in_use": False}) + "\n200", "")
            if method == "GET" and "/port-lists/" in path:
                return subprocess.CompletedProcess(["curl"], 0, json.dumps({"id": turbovasctl.IANA_TCP_UDP_PORT_LIST_ID, "name": "IANA"}) + "\n200", "")
            if method == "GET" and "/scanners/" in path:
                return subprocess.CompletedProcess(["curl"], 0, json.dumps({"id": turbovasctl.NATIVE_SCAN_NEW_SYSTEM_DEFAULT_SCANNER_ID, "name": "OpenVAS", "scanner_type": 2}) + "\n200", "")
            if method == "POST" and path.endswith("/clone"):
                body = json.loads(kwargs["body"])
                return subprocess.CompletedProcess(["curl"], 0, json.dumps({"id": ids["config"], "name": body["name"]}) + "\n201", "")
            if method == "POST" and path.endswith("/diagnostic-nvt-selection"):
                return subprocess.CompletedProcess(["curl"], 0, json.dumps({"config_id": ids["config"], "nvt_id": "1.3.6.1.4.1.25623.1.0.106223", "status": "selected"}) + "\n200", "")
            if method == "POST" and path == "/api/v1/targets":
                body = json.loads(kwargs["body"])
                return subprocess.CompletedProcess(["curl"], 0, json.dumps({"id": ids["target"], "name": body["name"]}) + "\n201", "")
            if method == "POST" and path == "/api/v1/tasks":
            ...
            if method == "DELETE" and path in {
                f"/api/v1/targets/{ids['target']}",
                f"/api/v1/targets/{ids['target']}/trash",
                f"/api/v1/scan-configs/{ids['config']}",
                f"/api/v1/scan-configs/{ids['config']}/trash",
            }:
                return subprocess.CompletedProcess(["curl"], 0, "{}\n204", "")
            raise AssertionError((method, path))
        ...
        self.assertEqual(result["details"]["cleanup"]["target"]["trash_hard_delete"], "deleted")
        self.assertEqual(result["details"]["cleanup"]["scan_config"]["trash_hard_delete"], "deleted")

    def test_native_nvt_diagnostic_scan_parser_and_removal_inventory(self):
        args = turbovasctl.build_parser().parse_args(
            [
        ...
        self.assertEqual(args.source_scan_config_id, turbovasctl.EMPTY_SCAN_CONFIG_ID)
        candidates = set().union(*turbovasctl.NATIVE_TOOLING_GVM_TOOLS_REMOVAL_BUCKETS.values())
        self.assertNotIn("nvt-scan.gmp.py", candidates)
        self.assertNotIn("start-nvt-scan.gmp.py", candidates)
        self.assertNotIn("nvt-scan.gmp.py", turbovasctl.NATIVE_TOOLING_GVM_TOOLS_PATH_BLOCKERS)
        self.assertNotIn("start-nvt-scan.gmp.py", turbovasctl.NATIVE_TOOLING_GVM_TOOLS_PATH_BLOCKERS)
    ...
    def test_native_empty_trash_parser_preview_and_local_write_guards(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            root = Path(tmp)
            with unittest.mock.patch.object(turbovasctl, "direct_native_api_curl") as curl:
                incomplete = turbovasctl.command_native_empty_trash(
                    root,
                    allow_write_control=True,
                    expected_total=0,
                )
                negative = turbovasctl.command_native_empty_trash(root, expected_total=-1)
    ...
    def test_native_empty_trash_preview_payload_is_complete_counts_only_contract(self):
        items = [
            ...
            for resource_type in sorted(turbovasctl.NATIVE_EMPTY_TRASH_RESOURCE_TYPES)
        ]
        items[0]["count"] = 3
        payload = {"scope": "operator", "items": items, "total": 3, "snapshot_digest": "a" * 64}
        self.assertEqual(turbovasctl.native_empty_trash_preview_payload(payload), payload)

        incomplete = dict(payload)
        incomplete["items"] = items[:-1]
        self.assertIsNone(turbovasctl.native_empty_trash_preview_payload(incomplete))
        unsafe = dict(payload)
        unsafe["items"] = [dict(item) for item in items]
        unsafe["items"][0]["name"] = "must-not-be-accepted"
        self.assertIsNone(turbovasctl.native_empty_trash_preview_payload(unsafe))
    ...
    def test_native_empty_trash_preview_only_uses_one_get_and_compact_output_stays_counts_only(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            with unittest.mock.patch.object(turbovasctl, "native_api_direct_runtime_env", return_value={}), \
                ...
                unittest.mock.patch.object(turbovasctl, "direct_native_api_curl", side_effect=fake_direct):
                result = turbovasctl.command_native_empty_trash(Path(tmp), status_only=True)

        self.assertEqual(result["status"], "pass")
        self.assertEqual(result["details"]["outcome"], "preview")
        self.assertEqual(result["details"]["preview_total"], 2)
        self.assertEqual(calls, [(turbovasctl.NATIVE_EMPTY_TRASH_PREVIEW_PATH, "GET")])
    ...
    def test_native_empty_trash_requires_fresh_total_match_before_one_post(self):
        ...
        def confirmed_direct(_root, path, **kwargs):
            ...
            if path == turbovasctl.NATIVE_EMPTY_TRASH_PREVIEW_PATH:
                return subprocess.CompletedProcess(["curl"], 0, json.dumps(preview) + "\n200", "")
            self.assertEqual(path, turbovasctl.NATIVE_EMPTY_TRASH_PATH)
        ...
        with tempfile.TemporaryDirectory() as tmp:
            root = Path(tmp)
            with common[0], common[1], common[2], unittest.mock.patch.object(turbovasctl, "direct_native_api_curl", side_effect=mismatch_direct):
                mismatch = turbovasctl.command_native_empty_trash(
                    root,
                    allow_write_control=True,
                    acknowledge_permanent_deletion=True,
                    expected_total=1,
            ...
            with unittest.mock.patch.object(turbovasctl, "native_api_direct_runtime_env", return_value={}), \
                unittest.mock.patch.object(turbovasctl, "native_api_direct_config_shape_finding", return_value=turbovasctl.finding("pass", "direct-config", "ok")), \
                unittest.mock.patch.object(turbovasctl, "native_api_direct_bearer_token", return_value="t" * 64), \
                unittest.mock.patch.object(turbovasctl, "direct_native_api_curl", side_effect=confirmed_direct):
                confirmed = turbovasctl.command_native_empty_trash(
                    root,
                    allow_write_control=True,
                    acknowledge_permanent_deletion=True,
                    expected_total=2,
        ...
        self.assertEqual(mismatch_calls, [(turbovasctl.NATIVE_EMPTY_TRASH_PREVIEW_PATH, "GET")])
        ...
        self.assertEqual(
            ...
            [
                (turbovasctl.NATIVE_EMPTY_TRASH_PREVIEW_PATH, "GET"),
                (turbovasctl.NATIVE_EMPTY_TRASH_PATH, "POST"),
            ],
        )
    ...
    def test_native_empty_trash_distinguishes_rejected_and_indeterminate_post_outcomes(self):
        ...
        def response_with_post(post_status, payload):
            ...
            def fake_direct(_root, path, **kwargs):
                calls.append((path, kwargs.get("method", "GET")))
                response_payload = preview if path == turbovasctl.NATIVE_EMPTY_TRASH_PREVIEW_PATH else payload
                status = 200 if path == turbovasctl.NATIVE_EMPTY_TRASH_PREVIEW_PATH else post_status
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with unittest.mock.patch.object(turbovasctl, "native_api_direct_runtime_env", return_value={}), \
                unittest.mock.patch.object(turbovasctl, "native_api_direct_config_shape_finding", return_value=turbovasctl.finding("pass", "direct-config", "ok")), \
                unittest.mock.patch.object(turbovasctl, "native_api_direct_bearer_token", return_value="t" * 64), \
                unittest.mock.patch.object(turbovasctl, "direct_native_api_curl", side_effect=rejected_direct):
                rejected = turbovasctl.command_native_empty_trash(root, allow_write_control=True, acknowledge_permanent_deletion=True, expected_total=0)
            with unittest.mock.patch.object(turbovasctl, "native_api_direct_runtime_env", return_value={}), \
                unittest.mock.patch.object(turbovasctl, "native_api_direct_config_shape_finding", return_value=turbovasctl.finding("pass", "direct-config", "ok")), \
                unittest.mock.patch.object(turbovasctl, "native_api_direct_bearer_token", return_value="t" * 64), \
                unittest.mock.patch.object(turbovasctl, "direct_native_api_curl", side_effect=indeterminate_direct):
                indeterminate = turbovasctl.command_native_empty_trash(root, allow_write_control=True, acknowledge_permanent_deletion=True, expected_total=0)

        self.assertEqual(rejected["details"]["outcome"], "rejected")
        self.assertEqual(indeterminate["details"]["outcome"], "indeterminate")
        self.assertEqual(rejected_calls, [(turbovasctl.NATIVE_EMPTY_TRASH_PREVIEW_PATH, "GET"), (turbovasctl.NATIVE_EMPTY_TRASH_PATH, "POST")])
        self.assertEqual(indeterminate_calls, [(turbovasctl.NATIVE_EMPTY_TRASH_PREVIEW_PATH, "GET"), (turbovasctl.NATIVE_EMPTY_TRASH_PATH, "POST")])
    ...
    def test_direct_trash_empty_smoke_uses_isolated_fixture_and_never_empties_preexisting_trash(self):
        ...
        def fake_direct(_root, path, **kwargs):
            ...
            if path == "/api/v1/tags/fixture-tag":
                return subprocess.CompletedProcess(["curl"], 0, "\n204", "")
            if path == turbovasctl.NATIVE_EMPTY_TRASH_PATH:
                body = json.loads(kwargs["body"])
        ...
        with tempfile.TemporaryDirectory() as tmp:
            with unittest.mock.patch.object(turbovasctl, "direct_native_api_curl", side_effect=fake_direct), \
                unittest.mock.patch.object(
                    turbovasctl,
                    "psql",
                    side_effect=[
                ...
                unittest.mock.patch.object(turbovasctl.time, "time", return_value=1):
                findings = turbovasctl.direct_trash_empty_runtime_findings(
                    Path(tmp),
                    token="t" * 64,
                    env={},
        ...
        self.assertEqual(
            [(path, method) for path, method, _body in calls if path == turbovasctl.NATIVE_EMPTY_TRASH_PATH],
            [
                (turbovasctl.NATIVE_EMPTY_TRASH_PATH, "POST"),
                (turbovasctl.NATIVE_EMPTY_TRASH_PATH, "POST"),
            ],
        ...
        self.assertEqual(
            [json.loads(body)["expected_total"] for path, _method, body in calls if path == turbovasctl.NATIVE_EMPTY_TRASH_PATH],
            [0, 1],
        )
        ...
        with tempfile.TemporaryDirectory() as tmp:
            with unittest.mock.patch.object(turbovasctl, "direct_native_api_curl", side_effect=preexisting_direct), \
                unittest.mock.patch.object(turbovasctl, "psql") as psql:
                skipped = turbovasctl.direct_trash_empty_runtime_findings(
                    Path(tmp),
                    token="t" * 64,
                    env={},
                    operator_uuid=operator_uuid,
    ...
    def test_native_bulk_stop_commands_require_write_control_before_runtime(self):
        with tempfile.TemporaryDirectory() as tmp:
            root = Path(tmp)
            csv_file = root / "tasks.csv"
            csv_file.write_text("Running\n", encoding="utf-8")
            with unittest.mock.patch.object(turbovasctl, "direct_native_api_curl") as curl:
                csv_result = turbovasctl.command_native_stop_tasks_from_csv(root, csv_file)
                all_result = turbovasctl.command_native_stop_all_tasks(root)
                curl.assert_not_called()

        self.assertEqual(csv_result["status"], "fail")
        self.assertEqual(all_result["status"], "fail")
        self.assertEqual(
            next(item for item in csv_result["findings"] if item["check"].endswith("write-control-intent"))["status"],
            "fail",
        )
        self.assertEqual(
            next(item for item in all_result["findings"] if item["check"].endswith("write-control-intent"))["status"],
            "fail",
        )

    def test_native_stop_tasks_from_csv_snapshots_resolves_safely_and_aggregates_failures(self):
        ids = {
            "Alpha": "11111111-1111-4111-8111-111111111111",
            "Idle": "22222222-2222-4222-8222-222222222222",
            "DuplicateA": "33333333-3333-4333-8333-333333333333",
            "DuplicateB": "44444444-4444-4444-8444-444444444444",
        ...
        def fake_direct(_root, path, **kwargs):
            method = kwargs.get("method", "GET")
            captured.append((method, path))
            if path == "/api/v1/tasks?page=1&page_size=500&sort=name":
                return subprocess.CompletedProcess(
                    ["curl"],
                    0,
                    json.dumps(
                        {
                            "items": [
                                {"id": ids["Alpha"], "name": "Alpha", "status": "Running"},
                                {"id": ids["Idle"], "name": "Idle", "status": "Done"},
                                {"id": ids["DuplicateA"], "name": "Duplicate", "status": "Requested"},
                            ],
                            "page": {"page": 1, "page_size": 3, "total": 5},
                        }
                    )
                    + "\n200",
                    "",
                )
            if path == "/api/v1/tasks?page=2&page_size=500&sort=name":
                return subprocess.CompletedProcess(
                    ["curl"],
                    0,
                    json.dumps(
                        {
                            "items": [
                                {"id": ids["DuplicateB"], "name": "Duplicate", "status": "Queued"},
                                {"id": ids["Failure"], "name": "Failure", "status": "Running"},
                            ],
                            "page": {"page": 2, "page_size": 3, "total": 5},
                        }
                    )
                    + "\n200",
                    "",
                )
            if path == f"/api/v1/tasks/{ids['Alpha']}/stop":
                return subprocess.CompletedProcess(
                    ["curl"],
                    0,
                    json.dumps({"task_id": ids["Alpha"], "status": "stopped"}) + "\n200",
                    "",
                )
            if path == f"/api/v1/tasks/{ids['Failure']}/stop":
                return subprocess.CompletedProcess(
                    ["curl"],
                    0,
                    '{"error":{"code":"scanner_unverified"}}\n502',
                    "",
                )
            self.fail(f"unexpected direct native API request: {method} {path}")
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with unittest.mock.patch.object(turbovasctl, "native_api_direct_runtime_env", return_value={}), \
                ...
                unittest.mock.patch.object(turbovasctl, "native_api_direct_bearer_token", return_value="a" * 64), \
                unittest.mock.patch.object(turbovasctl, "direct_native_api_curl", side_effect=fake_direct):
                result = turbovasctl.command_native_stop_tasks_from_csv(
                    root,
                    csv_file,
                    allow_write_control=True,
                )
        ...
        self.assertEqual(result["status"], "fail")
        self.assertEqual(result["details"]["row_count"], 6)
        self.assertEqual(result["details"]["task_count"], 5)
        self.assertEqual(result["details"]["matched_count"], 5)
        self.assertEqual(result["details"]["selected_count"], 2)
        self.assertEqual(result["details"]["skipped_count"], 3)
        self.assertEqual(result["details"]["stopped_count"], 1)
        self.assertEqual(result["details"]["failure_count"], 2)
        self.assertEqual(
            [path for method, path in captured if method == "GET"],
            [
                "/api/v1/tasks?page=1&page_size=500&sort=name",
                "/api/v1/tasks?page=2&page_size=500&sort=name",
            ],
        ...
        self.assertEqual(
            [path for method, path in captured if method == "POST"],
            [
                f"/api/v1/tasks/{ids['Alpha']}/stop",
                f"/api/v1/tasks/{ids['Failure']}/stop",
            ],
        )
        duplicate = next(row for row in result["details"]["rows"] if row["task_name"] == "Duplicate")
        self.assertEqual(duplicate["reason"], "multiple active tasks share this name")
        self.assertNotIn("a" * 64, json.dumps(result))

    def test_native_stop_all_tasks_filters_deduplicates_and_continues_after_failure(self):
        running_id = "11111111-1111-4111-8111-111111111111"
            ...
            if method == "GET":
                return subprocess.CompletedProcess(
                    ...
                    json.dumps(
                        {
                            "items": [
                                {"id": running_id, "name": "Running", "status": "Running"},
                                {"id": "33333333-3333-4333-8333-333333333333", "name": "Done", "status": "Done"},
                                {"id": queued_id, "name": "Queued", "status": "Requested"},
                                {"id": queued_id, "name": "Queued duplicate", "status": "Queued"},
                            ],
                            "page": {"page": 1, "page_size": 500, "total": 4},
                        }
                    )
                    + "\n200",
                    "",
                )
            if path == f"/api/v1/tasks/{running_id}/stop":
                return subprocess.CompletedProcess(
                    ["curl"],
                    0,
                    json.dumps({"task_id": running_id, "status": "stopped"}) + "\n200",
                    "",
                )
            if path == f"/api/v1/tasks/{queued_id}/stop":
                return subprocess.CompletedProcess(["curl"], 0, '{"error":{"code":"task_not_active"}}\n409', "")
            self.fail(f"unexpected direct native API request: {method} {path}")
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with unittest.mock.patch.object(turbovasctl, "native_api_direct_runtime_env", return_value={}), \
                ...
                unittest.mock.patch.object(turbovasctl, "native_api_direct_bearer_token", return_value="a" * 64), \
                unittest.mock.patch.object(turbovasctl, "direct_native_api_curl", side_effect=fake_direct):
                result = turbovasctl.command_native_stop_all_tasks(
                    root,
                    allow_write_control=True,
                    status_only=True,
                )
        ...
        self.assertEqual(result["status"], "fail")
        self.assertEqual(result["details"]["task_count"], 4)
        self.assertEqual(result["details"]["matched_count"], 3)
        self.assertEqual(result["details"]["selected_count"], 2)
        ...
        self.assertEqual(
            [path for method, path in captured if method == "POST"],
            [f"/api/v1/tasks/{queued_id}/stop", f"/api/v1/tasks/{running_id}/stop"],
        )

    def test_native_stop_all_tasks_list_failure_attempts_no_stop(self):
        captured: list[tuple[str, str]] = []

        def fake_direct(_root, path, **kwargs):
            captured.append((kwargs.get("method", "GET"), path))
            return subprocess.CompletedProcess(["curl"], 0, '{"error":{"code":"unavailable"}}\n503', "")
    ...
    def test_native_update_task_target_preflights_csv_and_accepts_typed_response(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with unittest.mock.patch.object(turbovasctl, "native_api_direct_runtime_env", return_value={}), \
                ...
                unittest.mock.patch.object(turbovasctl, "native_api_direct_bearer_token", return_value="a" * 64), \
                unittest.mock.patch.object(turbovasctl, "direct_native_api_curl", side_effect=fake_direct):
                result = turbovasctl.command_native_update_task_target(
                    root,
                    task_id=task_id,
    ...
    def test_native_update_task_target_rejects_invalid_input_or_missing_intent_before_runtime(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with unittest.mock.patch.object(turbovasctl, "native_api_direct_runtime_env") as runtime_env, \
                unittest.mock.patch.object(turbovasctl, "direct_native_api_curl") as curl:
                invalid = turbovasctl.command_native_update_task_target(
                    root,
                    task_id="not-a-uuid",
                    hosts=["192.0.2.10"],
                    allow_write_control=True,
                )
                empty = turbovasctl.command_native_update_task_target(
                    root,
                    task_id="11111111-1111-4111-8111-111111111111",
                    hosts_file=empty_hosts,
                    allow_write_control=True,
                )
                missing_intent = turbovasctl.command_native_update_task_target(
                    root,
                    task_id="11111111-1111-4111-8111-111111111111",
                    hosts=["192.0.2.10"],
                )
    ...
    def test_task_target_replace_runtime_cleanup_is_ordered_and_complete(self):
        source = inspect.getsource(turbovasctl.direct_task_target_replace_runtime_findings)
    ...
    def test_native_targets_from_host_list_parses_host_file_and_port_ranges(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            hosts_file.write_text("192.0.2.10\n\n example.invalid \n", encoding="utf-8")

            self.assertEqual(
                turbovasctl.load_native_target_host_list(hosts_file),
                ["192.0.2.10", "example.invalid"],
            )

        self.assertEqual(
            turbovasctl.parse_native_target_host_list_port_ranges("T:1-443,U:53"),
            [
        ...
        for bad_range in ("1-443", "T:0-1", "U:10-9", ","):
            with self.subTest(bad_range=bad_range):
                with self.assertRaises(ValueError):
                    turbovasctl.parse_native_target_host_list_port_ranges(bad_range)

    def test_native_targets_from_host_list_dry_run_plans_secret_free_payloads(self):
        with tempfile.TemporaryDirectory() as tmp:
            root = Path(tmp)
            hosts_file = root / "hosts.txt"
            hosts_file.write_text("192.0.2.10\n192.0.2.11\n", encoding="utf-8")
            result = turbovasctl.command_native_targets_from_host_list(
                root,
                hosts_file,
                port_range="T:1-443,U:53",
                port_list_name="Web and DNS",
                dry_run=True,
            )

        self.assertEqual(result["status"], "pass")
        details = result["details"]
        self.assertEqual(details["host_count"], 2)
        self.assertEqual(details["planned_port_list"]["name"], "Web and DNS")
        self.assertEqual(details["planned_targets"][0]["hosts"], ["192.0.2.10"])
        self.assertEqual(details["planned_targets"][0]["alive_tests"], ["Scan Config Default"])
        self.assertNotIn("credentials", details["planned_targets"][0])

    def test_native_targets_from_host_list_requires_write_control_before_runtime(self):
        with tempfile.TemporaryDirectory() as tmp:
            root = Path(tmp)
            hosts_file = root / "hosts.txt"
            hosts_file.write_text("192.0.2.10\n", encoding="utf-8")
            with unittest.mock.patch.object(turbovasctl, "direct_native_api_curl") as curl:
                result = turbovasctl.command_native_targets_from_host_list(root, hosts_file)
                curl.assert_not_called()

        self.assertEqual(result["status"], "fail")
        checks = {item["check"]: item for item in result["findings"]}
        self.assertEqual(checks["native-targets-from-host-list.write-control-intent"]["status"], "fail")

    def test_native_targets_from_host_list_uses_direct_api_for_port_list_and_targets(self):
        ...
        def fake_direct(_root, path, **kwargs):
            ...
            body = json.loads(kwargs["body"])
            if path == "/api/v1/port-lists":
                self.assertEqual(body["port_ranges"][0]["protocol"], "tcp")
                return subprocess.CompletedProcess(["curl"], 0, '{"id":"11111111-1111-4111-8111-111111111111","name":"Web"}\n201', "")
            self.assertEqual(path, "/api/v1/targets")
            self.assertEqual(body["port_list_id"], "11111111-1111-4111-8111-111111111111")
            self.assertEqual(body["alive_tests"], ["Scan Config Default"])
            self.assertNotIn("credentials", body)
            target_id = next(target_ids)
            return subprocess.CompletedProcess(["curl"], 0, json.dumps({"id": target_id, "name": body["name"]}) + "\n201", "")
        ...
        self.assertEqual(result["status"], "pass")
        self.assertEqual([path for path, _kwargs in captured], ["/api/v1/port-lists", "/api/v1/targets", "/api/v1/targets"])
    ...
    def test_native_alerts_from_csv_rejects_malformed_rows_before_runtime(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            for content in invalid_rows:
                csv_file.write_text(content, encoding="utf-8")
                with unittest.mock.patch.object(turbovasctl, "direct_native_api_curl") as curl:
                    result = turbovasctl.command_native_alerts_from_csv(root, csv_file, allow_write_control=True)
                    curl.assert_not_called()
                self.assertEqual(result["status"], "fail")
    ...
    def test_native_alert_csv_message_rejects_c1_controls_before_runtime(self):
        with self.assertRaisesRegex(ValueError, "message must be UTF-8 text"):
            turbovasctl.native_alert_csv_message(1, "visible\u0085control")
    ...
    def test_native_alerts_from_csv_defaults_to_offline_redacted_dry_run(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with unittest.mock.patch.object(turbovasctl, "direct_native_api_curl") as curl:
                result = turbovasctl.command_native_alerts_from_csv(root, csv_file, status_only=True)
                curl.assert_not_called()
        self.assertEqual(result["status"], "pass")
    ...
    def test_native_alerts_from_csv_resolves_metadata_before_exact_email_and_smb_posts(self):
        ...
        def fake_direct(_root, path, **kwargs):
            calls.append(path)
            if "?" in path:
                query = turbovasctl.urllib.parse.parse_qs(turbovasctl.urllib.parse.urlsplit(path).query)
                name = query["filter"][0]
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with (
                unittest.mock.patch.object(
                    ...
                    return_value={turbovasctl.TURBOVAS_API_OPERATOR_UUID_ENV: operator_uuid},
                ),
                unittest.mock.patch.object(turbovasctl, "native_api_direct_config_shape_finding", return_value=turbovasctl.finding("pass", "config", "ok")),
                unittest.mock.patch.object(turbovasctl, "native_api_direct_bearer_token", return_value="a" * 64),
                unittest.mock.patch.object(turbovasctl, "direct_native_api_curl", side_effect=fake_direct),
            ):
                result = turbovasctl.command_native_alerts_from_csv(root, csv_file, allow_write_control=True)
        ...
        self.assertEqual(bodies[0], {
            "method": "EMAIL", "name": "Mail", "comment": turbovasctl.NATIVE_ALERT_CSV_COMMENT,
        ...
        self.assertEqual(bodies[1], {
            "method": "SMB", "name": "Share", "comment": turbovasctl.NATIVE_ALERT_CSV_COMMENT,
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            for metadata in invalid_metadata:
                ...
                with (
                    ...
                    unittest.mock.patch.object(turbovasctl, "native_api_direct_config_shape_finding", return_value=turbovasctl.finding("pass", "config", "ok")),
                    unittest.mock.patch.object(turbovasctl, "native_api_direct_bearer_token", return_value="b" * 64),
                    unittest.mock.patch.object(turbovasctl, "direct_native_api_curl", side_effect=fake_direct) as curl,
                ):
                    result = turbovasctl.command_native_alerts_from_csv(root, csv_file, allow_write_control=True)
                self.assertEqual(result["status"], "fail")
                self.assertEqual(result["details"]["preflight_failure_count"], 1)
    ...
    def test_native_alert_csv_redaction_does_not_confuse_smb_credential_name_with_method_type(self):
        row = turbovasctl.NativeAlertCsvRow(
            row_number=1,
            name="Share",
            method="SMB",
            status="Done",
        ...
        self.assertTrue(turbovasctl.native_alert_csv_response_is_redacted(response, row))
        response["smb_credential"] = "SMB"
        self.assertFalse(turbovasctl.native_alert_csv_response_is_redacted(response, row))
    ...
    def test_native_alerts_from_csv_stops_after_indeterminate_mutation_without_payload_leaks(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with (
                ...
                result = turbovasctl.command_native_alerts_from_csv(root, csv_file, allow_write_control=True, status_only=True)
        self.assertEqual(result["status"], "fail")
    ...
    def test_native_schedules_from_csv_parses_rows_and_dry_runs_without_calendar_payloads(self):
        with tempfile.TemporaryDirectory() as tmp:
            root = Path(tmp)
            csv_file = root / "schedules.csv"
            csv_file.write_text(
                'Nightly,Europe/Berlin,"BEGIN:VCALENDAR\nVERSION:2.0\nEND:VCALENDAR"\n',
                encoding="utf-8",
            )
            with unittest.mock.patch.object(turbovasctl, "direct_native_api_curl") as curl:
                result = turbovasctl.command_native_schedules_from_csv(root, csv_file, dry_run=True)
                curl.assert_not_called()

        self.assertEqual(result["status"], "pass")
        planned = result["details"]["planned_schedules"][0]
        self.assertEqual(planned["name"], "Nightly")
        self.assertEqual(planned["comment"], turbovasctl.NATIVE_SCHEDULE_CSV_COMMENT)
        self.assertNotIn("icalendar", planned)
        self.assertEqual(planned["icalendar_bytes"], len("BEGIN:VCALENDAR\nVERSION:2.0\nEND:VCALENDAR".encode()))
        self.assertNotIn("BEGIN:VCALENDAR", json.dumps(result))

    def test_native_schedules_from_csv_rejects_malformed_rows_before_runtime(self):
        with tempfile.TemporaryDirectory() as tmp:
            root = Path(tmp)
            csv_file = root / "schedules.csv"
            csv_file.write_text("Valid,UTC,BEGIN:VCALENDAR\nMalformed,UTC\n", encoding="utf-8")
            with unittest.mock.patch.object(turbovasctl, "direct_native_api_curl") as curl:
                result = turbovasctl.command_native_schedules_from_csv(root, csv_file, allow_write_control=True)
                curl.assert_not_called()

        self.assertEqual(result["status"], "fail")
        self.assertEqual(result["findings"][0]["check"], "native-schedules-from-csv.rows")

    def test_native_schedules_from_csv_skips_duplicates_and_existing_names_through_paged_get(self):
        paths: list[str] = []
        ...
        def fake_direct(_root, path, **kwargs):
            ...
            if path.startswith("/api/v1/schedules?"):
                ...
                if name == "Existing":
                    items = [] if page == 1 else [{"id": "existing-id", "name": name}]
                    total = 101
                else:
                    items = []
                    total = 0
                return subprocess.CompletedProcess(["curl"], 0, json.dumps({"page": {"total": total, "page": page, "page_size": 100}, "items": items}) + "\n200", "")
            self.assertEqual(path, "/api/v1/schedules")
            created.append(json.loads(kwargs["body"]))
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            csv_file = root / "schedules.csv"
            csv_file.write_text(
                "New,UTC,BEGIN:VCALENDAR\nNew,UTC,BEGIN:VCALENDAR\nExisting,UTC,BEGIN:VCALENDAR\n",
                encoding="utf-8",
            )
            with (
                unittest.mock.patch.object(turbovasctl, "native_api_direct_runtime_env", return_value={}),
    ...
    def test_native_schedules_from_csv_matches_api_byte_and_control_boundaries(self):
        with tempfile.TemporaryDirectory() as tmp:
            root = Path(tmp)
            valid = root / "valid.csv"
            calendar = "BEGIN:VCALENDAR\r\nSUMMARY:Übernachtung\r\n\tEND:VCALENDAR"
            csv_buffer = io.StringIO()
            csv.writer(csv_buffer, lineterminator="\n").writerow(["é" * 2048, "  Europe/Berlin  ", calendar])
            valid.write_text(csv_buffer.getvalue(), encoding="utf-8", newline="")
            rows = turbovasctl.load_native_schedule_csv_rows(valid)

            self.assertEqual(rows[0].name, "é" * 2048)
            self.assertEqual(rows[0].timezone, "Europe/Berlin")
            self.assertEqual(rows[0].icalendar, calendar)
            self.assertEqual(turbovasctl.native_schedule_csv_schedule_body(rows[0])["icalendar"], calendar)

            too_long = root / "too-long.csv"
            too_long.write_text(f"{'é' * 2049},UTC,BEGIN:VCALENDAR\n", encoding="utf-8")
            with self.assertRaisesRegex(ValueError, "exceeds 4096"):
                turbovasctl.load_native_schedule_csv_rows(too_long)

            bad_calendar = root / "bad-calendar.csv"
            bad_calendar.write_text("Name,UTC,BEGIN:VCALENDAR\x0b\n", encoding="utf-8")
            with self.assertRaisesRegex(ValueError, "unsupported control"):
                turbovasctl.load_native_schedule_csv_rows(bad_calendar)

            bad_name = root / "bad-name.csv"
    ...
    def test_native_schedules_from_csv_requires_explicit_write_confirmation(self):
        with tempfile.TemporaryDirectory() as tmp:
            root = Path(tmp)
            csv_file = root / "schedules.csv"
            csv_file.write_text("Nightly,UTC,BEGIN:VCALENDAR\n", encoding="utf-8")
            with unittest.mock.patch.object(turbovasctl, "direct_native_api_curl") as curl:
                result = turbovasctl.command_native_schedules_from_csv(root, csv_file)
                curl.assert_not_called()

        self.assertEqual(result["status"], "fail")
        self.assertEqual(result["findings"][1]["check"], "native-schedules-from-csv.write-control-intent")

    def test_native_schedules_from_csv_posts_exact_native_request_shape(self):
        requests: list[tuple[str, dict[str, object]]] = []

        def fake_direct(_root, path, **kwargs):
            if path.startswith("/api/v1/schedules?"):
                return subprocess.CompletedProcess(["curl"], 0, '{"page":{"total":0},"items":[]}\n200', "")
            requests.append((path, {"method": kwargs["method"], "body": json.loads(kwargs["body"]), "headers": kwargs["extra_headers"]}))
            return subprocess.CompletedProcess(["curl"], 0, '{"id":"new-id"}\n201', "")

        with tempfile.TemporaryDirectory() as tmp:
            root = Path(tmp)
            csv_file = root / "schedules.csv"
            csv_file.write_text("Nightly,Europe/Berlin,BEGIN:VCALENDAR\n", encoding="utf-8")
            with (
                unittest.mock.patch.object(turbovasctl, "native_api_direct_runtime_env", return_value={}),
                unittest.mock.patch.object(turbovasctl, "native_api_direct_config_shape_finding", return_value=turbovasctl.finding("pass", "direct-config", "ok")),
                unittest.mock.patch.object(turbovasctl, "native_api_direct_bearer_token", return_value="b" * 64),
        ...
        self.assertEqual(result["status"], "pass")
        self.assertEqual(requests[0][0], "/api/v1/schedules")
        self.assertEqual(requests[0][1]["method"], "POST")
        self.assertEqual(
            requests[0][1]["body"],
            {
                "name": "Nightly",
                "comment": turbovasctl.NATIVE_SCHEDULE_CSV_COMMENT,
                "timezone": "Europe/Berlin",
                "icalendar": "BEGIN:VCALENDAR",
            },
        )
        self.assertEqual(requests[0][1]["headers"], (("Content-Type", "application/json"),))

    def test_native_schedules_from_csv_continues_and_aggregates_create_failures(self):
        attempted: list[str] = []
        ...
        def fake_direct(_root, path, **kwargs):
            ...
            attempted.append(body["name"])
            if body["name"] == "Broken":
                return subprocess.CompletedProcess(["curl"], 0, '{"error":{"code":"conflict","message":"rejected"}}\n409', "")
            return subprocess.CompletedProcess(["curl"], 0, '{"id":"created-id"}\n201', "")

        with tempfile.TemporaryDirectory() as tmp:
            root = Path(tmp)
            csv_file = root / "schedules.csv"
            csv_file.write_text(
                "First,UTC,BEGIN:VCALENDAR\nBroken,UTC,BEGIN:VCALENDAR\nLast,UTC,BEGIN:VCALENDAR\n",
                encoding="utf-8",
            )
            with (
                unittest.mock.patch.object(turbovasctl, "native_api_direct_runtime_env", return_value={}),
        ...
        self.assertEqual(result["details"]["created_schedule_count"], 2)
    ...
    def test_native_schedule_create_openapi_schema_is_exact(self):
        root = Path(__file__).resolve().parents[2]
        drift = turbovasctl.openapi_schedule_create_schema_contract_drift(root, turbovasctl.openapi_contract_operations(root))
    ...
    def test_native_targets_from_csv_parses_rows_and_dry_runs_payloads(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            rows = turbovasctl.load_native_target_csv_rows(csv_file)
            self.assertEqual(len(rows), 1)
            self.assertEqual(rows[0].name, "CSV target")
            self.assertEqual(rows[0].alive_test, "ICMP Ping")

            result = turbovasctl.command_native_targets_from_csv(root, csv_file, dry_run=True)
    ...
    def test_native_targets_from_csv_requires_write_control_before_runtime(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with unittest.mock.patch.object(turbovasctl, "direct_native_api_curl") as curl:
                result = turbovasctl.command_native_targets_from_csv(root, csv_file)
                curl.assert_not_called()
    ...
    def test_native_targets_from_csv_preflights_credentials_and_skips_existing_targets(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with unittest.mock.patch.object(turbovasctl, "native_api_direct_runtime_env", return_value={}), \
                ...
                unittest.mock.patch.object(turbovasctl, "native_api_direct_bearer_token", return_value="a" * 64), \
                unittest.mock.patch.object(turbovasctl, "direct_native_api_curl", side_effect=fake_direct):
                result = turbovasctl.command_native_targets_from_csv(root, csv_file, allow_write_control=True, status_only=True)
    ...
    def test_native_targets_from_csv_exact_lookup_pages_until_match(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            root = Path(tmp)
            with unittest.mock.patch.object(turbovasctl, "direct_native_api_curl", side_effect=fake_direct):
                matches, failure = turbovasctl.native_target_csv_fetch_exact_items(
                    root,
                    "/api/v1/credentials",
                    "needle",
                    token="a" * 64,
                    env={},
                    allowed_types=turbovasctl.NATIVE_TARGET_CSV_SMB_CREDENTIAL_TYPES,
                )
...
""",
            ...
            rows = turbovasctl.load_native_target_xml_rows(xml_file)
            self.assertEqual(len(rows), 1)
            self.assertEqual(rows[0].hosts, ("192.0.2.10", "192.0.2.11"))

            result = turbovasctl.command_native_targets_from_xml(root, xml_file, dry_run=True)
...
""",
            ...
            with unittest.mock.patch.object(turbovasctl, "direct_native_api_curl") as curl:
                result = turbovasctl.command_native_targets_from_xml(root, xml_file)
                curl.assert_not_called()
...
""",
            ...
            with unittest.mock.patch.object(turbovasctl, "native_api_direct_runtime_env", return_value={}), \
                ...
                unittest.mock.patch.object(turbovasctl, "native_api_direct_bearer_token", return_value="a" * 64), \
                unittest.mock.patch.object(turbovasctl, "direct_native_api_curl", side_effect=fake_direct):
                result = turbovasctl.command_native_targets_from_xml(root, xml_file, allow_write_control=True, status_only=True)
    ...
    def test_native_tags_from_csv_parses_supported_subset_and_dry_runs_payloads(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            csv_file.write_text("TARGET,Owner,Production,Target A,Target B\n\n", encoding="utf-8")

            rows = turbovasctl.load_native_tag_csv_rows(csv_file)
            self.assertEqual(len(rows), 1)
            self.assertEqual(rows[0].tag_name, "Owner:Production:TARGET")
            self.assertEqual(rows[0].resource_type, "target")
            self.assertEqual(rows[0].resource_names, ("Target A", "Target B"))

            result = turbovasctl.command_native_tags_from_csv(root, csv_file, dry_run=True)

        self.assertEqual(result["status"], "pass")
        planned = result["details"]["planned_tags"][0]
        self.assertEqual(planned["tag"]["name"], "Owner:Production:TARGET")
        self.assertEqual(planned["tag"]["resource_type"], "target")
    ...
    def test_native_tags_from_csv_requires_write_control_before_runtime(self):
        with tempfile.TemporaryDirectory() as tmp:
            root = Path(tmp)
            csv_file = root / "tags.csv"
            csv_file.write_text("TASK,Owner,Production,Task A\n", encoding="utf-8")
            with unittest.mock.patch.object(turbovasctl, "direct_native_api_curl") as curl:
                result = turbovasctl.command_native_tags_from_csv(root, csv_file)
                curl.assert_not_called()
    ...
    def test_native_tags_from_csv_resolves_resources_skips_existing_and_creates_tags(self):
        ...
        def fake_direct(_root, path, **kwargs):
            ...
            if path.startswith("/api/v1/tags?"):
                name = query_value(path, "filter")
                items = [{"id": "11111111-1111-4111-8111-111111111111", "name": name}] if name == "Existing:Prod:TASK" else []
                return subprocess.CompletedProcess(["curl"], 0, json.dumps({"page": {"total": len(items)}, "items": items}) + "\n200", "")
            if path.startswith("/api/v1/tags/resource-names/task?"):
                name = query_value(path, "filter")
                item = {"id": "22222222-2222-4222-8222-222222222222", "name": name}
                return subprocess.CompletedProcess(["curl"], 0, json.dumps({"page": {"total": 1}, "items": [item]}) + "\n200", "")
            if path == "/api/v1/tags":
                body = json.loads(kwargs["body"])
                created_bodies.append(body)
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            csv_file = root / "tags.csv"
            csv_file.write_text(
                "TASK,Owner,Prod,Task A\n"
                "TASK,Owner,Prod,Task B\n"
                "TASK,Existing,Prod,Task C\n",
                encoding="utf-8",
            )
            with unittest.mock.patch.object(turbovasctl, "native_api_direct_runtime_env", return_value={}), \
                unittest.mock.patch.object(turbovasctl, "native_api_direct_config_shape_finding", return_value=turbovasctl.finding("pass", "direct-config", "ok")), \
    ...
    def test_native_tags_from_csv_exact_lookup_pages_until_match(self):
        def fake_direct(_root, path, **_kwargs):
            ...
            if page == 1:
                ...
                items = [{"id": "22222222-2222-4222-8222-222222222222", "name": "needle"}]
            return subprocess.CompletedProcess(["curl"], 0, json.dumps({"page": {"page": page, "page_size": 1, "total": 2}, "items": items}) + "\n200", "")

        with tempfile.TemporaryDirectory() as tmp:
            root = Path(tmp)
            with unittest.mock.patch.object(turbovasctl, "direct_native_api_curl", side_effect=fake_direct):
                matches, failure = turbovasctl.native_tag_csv_fetch_exact_items(
                    root,
    ...
    def test_openapi_tracks_direct_feed_security_information_and_alert_tag_lookup_contracts(self):
        ...
        self.assertEqual(trashcan_summary["x_turbovas_values"]["x-turbovas-inherited-still-owns"], "trashcan-deep-row-data-and-mutations")
        ...
        self.assertIn("tag-dialog resource-name lookups, including alert, credential, report, and result", boundary)
    ...
    def test_native_tooling_removal_review_counts_product_scripts_toward_full_removal(self):
        summary = turbovasctl.summarize_native_tooling(
            [
                {
...
"""
    ...
    def test_direct_native_api_runtime_env_uses_token_file_by_default(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertTrue(env[turbovasctl.TURBOVAS_API_BROWSER_PROXY_SECRET_ENV])
    ...
    def test_direct_native_api_write_smoke_status_only_preserves_fixture_warnings(self):
        result = {
            ...
            "findings": [
                ...
                {"status": "warn", "check": "native-api-direct.schedule-write-create", "message": "missing schedule fixture"},
                {"status": "pass", "check": "native-api-direct.tag-resource-add", "message": "ok"},
                {"status": "pass", "check": "native-api-direct.task-stop-missing", "message": "ok"},
        ...
        self.assertEqual(compact["status"], "warn")
        self.assertEqual(compact["details"]["non_pass_count"], 2)
        self.assertEqual([item["check"] for item in compact["findings"]], ["native-api-direct.report-config-fixture", "native-api-direct.schedule-write-create"])
        ...
        self.assertEqual(checks["native-api-direct.schedule-write-create"], "warn")
    ...
    def test_native_api_create_cleanup_state_marks_malformed_201_and_committed_502_uncertain(self):
        malformed_201 = turbovasctl.subprocess.CompletedProcess([], 0, '{"name":"unexpected"}\n201', "")
        malformed_parsed, malformed_status = turbovasctl.parse_json_output_with_http_status(malformed_201)
        self.assertEqual(
            turbovasctl.native_api_create_cleanup_state(
                malformed_201,
                malformed_parsed,
                malformed_status,
                False,
        ...
        generic_503 = turbovasctl.subprocess.CompletedProcess(
            [],
            0,
            '{"error":{"code":"service_unavailable"}}\n503',
            "",
        )
        generic_parsed, generic_status = turbovasctl.parse_json_output_with_http_status(generic_503)
        self.assertEqual(
            turbovasctl.native_api_create_cleanup_state(
                generic_503,
                generic_parsed,
        ...
        missing_status = turbovasctl.subprocess.CompletedProcess([], 0, '{}', "")
        self.assertEqual(
            turbovasctl.native_api_create_cleanup_state(
                missing_status,
                {},
        ...
        committed_502 = turbovasctl.subprocess.CompletedProcess(
            [],
            0,
            '{"error":{"code":"committed_response_unavailable"}}\n502',
            "",
        )
        committed_parsed, committed_status = turbovasctl.parse_json_output_with_http_status(committed_502)
        self.assertEqual(
            turbovasctl.native_api_create_cleanup_state(
                committed_502,
                committed_parsed,
        ...
        self.assertEqual(
            turbovasctl.native_api_cleanup_identity_predicate(None, "temporary alert"),
    ...
    def test_smb_fixture_cleanup_failure_retains_report_format_and_credential(self):
        failed_cleanup = turbovasctl.subprocess.CompletedProcess(
            ["psql"],
            0,
            "1|0\n",
            "",
        )
        with unittest.mock.patch.object(turbovasctl, "psql", return_value=failed_cleanup) as psql:
            findings = turbovasctl.native_api_direct_write_smb_fixture_cleanup(
                Path("/tmp/TurboVAS"),
    ...
    def test_smb_fixture_cleanup_orders_alert_format_then_owner_name_credential(self):
        responses = (
            turbovasctl.subprocess.CompletedProcess(["psql"], 0, "0|0\n", ""),
            turbovasctl.subprocess.CompletedProcess(["psql"], 0, "1\n", ""),
            turbovasctl.subprocess.CompletedProcess(["psql"], 0, "1\n", ""),
        )
        with unittest.mock.patch.object(turbovasctl, "psql", side_effect=responses) as psql:
            findings = turbovasctl.native_api_direct_write_smb_fixture_cleanup(
                Path("/tmp/TurboVAS"),
                admin_uuid="11111111-1111-1111-1111-111111111111",
                smb_alert_attempted=True,
    ...
    def test_direct_native_api_write_smoke_uses_guarded_operator_and_cleans_up(self):
            ...
            def fake_run_command(command, *_args, **kwargs):
                ...
                if any(part == "psql" for part in command):
                    ...
                    if "deleted_alert AS" in command_text and "deleted_schedule AS" in command_text and "deleted_tag AS" in command_text:
                        return turbovasctl.subprocess.CompletedProcess(command, 0, "1|1|1\n", "")
                    ...
                    if "SELECT string_agg(name, ',' ORDER BY name) FROM alert_method_data" in command_text:
                        return turbovasctl.subprocess.CompletedProcess(command, 0, "smb_credential,smb_file_path,smb_report_format,smb_share_path\n", "")
            ...
            def fake_direct_curl(_root, path, *, method="GET", body=None, **_kwargs):
                ...
                if method == "POST" and path == "/api/v1/alerts":
                    ...
                    if payload["name"].endswith("-concurrent"):
                        ...
                        if alert_concurrent_calls["value"] == 1:
                            return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps({"id": alert_concurrent_uuid, "name": payload["name"], "active": False}) + "\n201", "")
                    ...
                    if payload.get("method") == "SMB":
                        ...
                        return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps({"id": alert_uuid, "name": payload["name"], "active": False, "event": {"type": "Task run status changed"}, "condition": {"type": "Always"}, "method": {"type": "SMB"}, "method_data_redacted": True, "tasks": []}) + "\n201", "")
                    ...
                    return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps({"id": alert_uuid, "name": payload["name"], "comment": payload["comment"], "active": False, "event": {"type": "Task run status changed"}, "condition": {"type": "Always"}, "method": {"type": "Email"}, "method_data_redacted": True, "tasks": []}) + "\n201", "")
                ...
                if method == "POST" and path == "/api/v1/credentials":
                    ...
                    if payload["login"] == "turbovas-helper-smoke":
                        return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps({"id": credential_helper_uuid, "name": payload["name"], "comment": payload["comment"], "credential_type": "up", "owner": "admin", "owner_id": operator_uuid, "smb_compatible": True}) + "\n201", "")
                    self.assertEqual(payload["login"], "turbovas-direct-write-smoke-user")
                    return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps({"id": credential_uuid, "name": payload["name"], "comment": payload["comment"], "credential_type": "up", "owner": "admin", "owner_id": operator_uuid, "smb_compatible": True}) + "\n201", "")
                if method == "POST" and path == "/api/v1/targets":
                    payload = json.loads(body)
                ...
                if method == "POST" and path == f"/api/v1/scanners/{scanner_uuid}/verify":
                    return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps({"scanner_id": scanner_uuid, "scanner_type": 2, "verified": True, "verification_mode": "osp-unix-socket", "version": "23.11"}) + "\n200", "")
                if method == "POST" and path == "/api/v1/tasks":
                    payload = json.loads(body)
                ...
                if method == "POST" and path == f"/api/v1/tasks/{task_uuid}/clone":
                    ...
                    payload = {
                        "id": task_clone_uuid,
                        "name": f"turbovas-direct-write-smoke-task-1-{turbovasctl.os.getpid()} Clone 1",
                        "comment": task_updated_comment,
                        "status": "New",
                        "target": {"id": target_uuid, "name": "temporary target"},
                        "config": {"id": turbovasctl.FULL_AND_FAST_SCAN_CONFIG_ID, "name": "Full and fast"},
                ...
                if method == "GET" and path == f"/api/v1/tasks/{task_clone_uuid}":
                    if task_clone_live["value"]:
                        return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps({"id": task_clone_uuid}) + "\n200", "")
                    return turbovasctl.subprocess.CompletedProcess([], 0, '{"error":{"code":"not_found"}}\n404', "")
                ...
                if method == "POST" and path == "/api/v1/scan-configs":
                    payload = json.loads(body)
                    assert payload["base_scan_config_id"] == turbovasctl.FULL_AND_FAST_SCAN_CONFIG_ID
                    scan_config_live["value"] = True
                    return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps({"id": scan_config_uuid, "comment": payload["comment"], "name": payload["name"], "predefined": False}) + "\n201", "")
                ...
                if method == "POST" and path.startswith(f"/api/v1/scan-configs/{scan_config_uuid}/clone"):
                    ...
                    return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps({"id": scan_config_clone_uuid, "comment": payload["comment"], "name": payload["name"], "predefined": False}) + "\n201", "")
                ...
                if method == "POST" and path == f"/api/v1/port-lists/{temp_port_list_uuid}/ranges":
                    ...
                    if any(item["protocol"] == "udp" and item["start"] == 65002 and item["end"] == 65002 for item in temp_port_list_ranges["value"]):
                        return turbovasctl.subprocess.CompletedProcess([], 0, '{"error":{"code":"conflict","message":"port range overlaps an existing range"}}\n409', "")
                    temp_port_list_ranges["value"].append({"id": temp_port_range_uuid, "protocol": "udp", "start": 65002, "end": 65002})
                    return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps({"id": temp_port_list_uuid, "name": "turbovas-direct-write-smoke-port-list-1-1", "predefined": False, "port_ranges": temp_port_list_ranges["value"]}) + "\n201", "")
                ...
                if method == "POST" and path.startswith(f"/api/v1/port-lists/{temp_port_list_uuid}/clone"):
                    payload = json.loads(body)
                    return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps({"id": temp_port_list_clone_uuid, "name": payload["name"], "predefined": False, "port_ranges": temp_port_list_ranges["value"]}) + "\n201", "")
                ...
                if method == "GET" and path.startswith(f"/api/v1/port-lists/{temp_port_list_uuid}"):
                    if temp_port_list_live["value"]:
                        return turbovasctl.subprocess.CompletedProcess([], 0, json.dumps({"id": temp_port_list_uuid, "port_ranges": temp_port_list_ranges["value"]}) + "\n200", "")
                    return turbovasctl.subprocess.CompletedProcess([], 0, '{"error":{"code":"not_found"}}\n404', "")
        ...
        self.assertIn(f"turbovas-direct-write-smoke-task-1-{turbovasctl.os.getpid()} Clone 1", task_cleanup_command)
