...
const DIRECT_API_BIND_ENV: &str = "YAFVS_API_DIRECT_BIND";
const DIRECT_API_BEARER_TOKEN_ENV: &str = "YAFVS_API_BEARER_TOKEN";
const DIRECT_API_BEARER_TOKEN_FILE_ENV: &str = "YAFVS_API_BEARER_TOKEN_FILE";
const DIRECT_API_OPERATOR_UUID_ENV: &str = "YAFVS_API_OPERATOR_UUID";
const DIRECT_API_OPERATOR_NAME_ENV: &str = "YAFVS_API_OPERATOR_NAME";
const DIRECT_API_WRITE_CONTROL_ENV: &str = "YAFVS_API_DIRECT_WRITE_CONTROL";
