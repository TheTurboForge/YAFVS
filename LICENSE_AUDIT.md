...
TurboVAS replaces OpenVAS Scanner's internal delimiter-based result rows with a
...
tests are original TurboVAS files under the governing scanner subtree license;
