...
command_t gmp_commands[]
 = {{"AUTHENTICATE", "Authenticate with the manager." },
    ...
    {"GET_REPORT_METRICS", "Get CVSS Load and authenticated coverage metrics for a report."},
    ...
    {"GET_SCOPE_REPORT", "Get one scope report."},
    {"GET_SCOPE_REPORT_METRICS", "Get CVSS Load and authenticated coverage metrics for a scope report."},
    {"GET_SCOPE_REPORTS", "Get scope reports."},
