...
pub use commands::{
    ...
    command_c_hardening_manifest_write, command_configure, command_deps, command_doctor,
    ...
    command_native_export_report_pdf, command_native_nvt_diagnostic_scan,
    command_native_scan_new_system, command_native_scan_with_delivery,
    ...
    command_runtime_gmp_smoke, command_runtime_identity_migrate, command_runtime_init,
    command_runtime_log_review, command_runtime_manager_init,
    command_runtime_native_api_direct_bootstrap, command_runtime_native_api_direct_smoke,
    command_runtime_native_api_direct_token, command_runtime_native_api_rebuild,
    command_runtime_native_api_smoke, command_runtime_nmap_capability_check,
    command_runtime_performance_snapshot, command_runtime_plan, command_runtime_rbac_smoke,
    command_runtime_redis_state, command_runtime_report_export, command_runtime_report_metrics,
    command_runtime_report_summary, command_runtime_scanner_capability_check,
    command_runtime_scanner_process_check, command_runtime_scanner_redis_init,
    command_runtime_scanner_register, command_runtime_scope_report_metrics,
    command_runtime_scope_report_summary, command_runtime_scope_smoke, command_runtime_smoke,
    command_runtime_status, command_runtime_webui_smoke, command_rust_migration_state,
    command_security_policy_check, command_status, command_up, find_repo_root,
};
...
pub fn run(cli: &Cli, cwd: &Path) -> ResultEnvelope {
    ...
    match &cli.command {
        ...
        CliCommand::RuntimeInit => command_runtime_init(&repo_root),
        CliCommand::RuntimeManagerInit => command_runtime_manager_init(&repo_root),
        ...
        CliCommand::Build {
            ...
            install,
            profile,
        } => command_build(&repo_root, component, *install, true, profile.as_deref()),
        CliCommand::BuildCoreC { profile } => command_build_core_c(&repo_root, profile.as_deref()),
